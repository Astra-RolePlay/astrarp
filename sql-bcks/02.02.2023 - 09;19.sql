...
-- elused.ak4y_fishing: ~1 rows (yaklaşık) tablosu için veriler indiriliyor
...
INSERT INTO `crypto` (`crypto`, `worth`, `history`) VALUES
	('qbit', 1047, '[{"PreviousWorth":1037,"NewWorth":1037},{"PreviousWorth":1037,"NewWorth":1037},{"PreviousWorth":1037,"NewWorth":1037},{"PreviousWorth":1037,"NewWorth":1047}]');
...
-- elused.gacha_playlists: ~8 rows (yaklaşık) tablosu için veriler indiriliyor
...
-- elused.gacha_playlists_users: ~6 rows (yaklaşık) tablosu için veriler indiriliyor
...
INSERT INTO `gacha_playlists_users` (`id`, `license`, `playlist`) VALUES
	...
	(8, 'license:579c4cc24ed4bb55b371e0fd1d553aa624337fd6', 8);
...
-- elused.gloveboxitems: ~47 rows (yaklaşık) tablosu için veriler indiriliyor
...
-- elused.mdt_config: ~3 rows (yaklaşık) tablosu için veriler indiriliyor
...
-- elused.mdt_profiles: ~1 rows (yaklaşık) tablosu için veriler indiriliyor
...
-- elused.npwd_match_profiles: ~22 rows (yaklaşık) tablosu için veriler indiriliyor
...
-- elused.npwd_match_views: ~5 rows (yaklaşık) tablosu için veriler indiriliyor
...
-- elused.npwd_phone_gallery: ~11 rows (yaklaşık) tablosu için veriler indiriliyor
...
-- elused.npwd_twitter_profiles: ~17 rows (yaklaşık) tablosu için veriler indiriliyor
...
-- elused.npwd_twitter_tweets: ~10 rows (yaklaşık) tablosu için veriler indiriliyor
...
-- elused.pefcl_accounts: ~25 rows (yaklaşık) tablosu için veriler indiriliyor
...
INSERT INTO `pefcl_accounts` (`id`, `number`, `accountName`, `isDefault`, `ownerIdentifier`, `role`, `balance`, `type`, `createdAt`, `updatedAt`, `deletedAt`) VALUES
	...
	(8, '920,5110-2000-3411', 'Personal account', 1, 'HGO75866', 'owner', 120, 'personal', '2024-01-27 13:26:49', '2024-01-27 14:13:39', NULL),
	...
	(12, '920,4652-0222-1658', 'Personal account', 1, 'XRK76375', 'owner', 5708, 'personal', '2024-01-31 14:21:55', '2024-02-02 01:44:38', NULL),
	...
	(19, '920,7027-3554-2043', 'Personal account', 1, 'CDR37384', 'owner', 500, 'personal', '2024-02-01 14:05:18', '2024-02-01 14:16:00', NULL),
	...
	(22, '920,2746-1876-0323', 'Personal account', 1, 'PAE72962', 'owner', 34035, 'personal', '2024-02-01 15:35:06', '2024-02-02 06:03:26', NULL),
...
-- elused.pefcl_transactions: ~135 rows (yaklaşık) tablosu için veriler indiriliyor
...
CREATE TABLE IF NOT EXISTS `players` (
  ...
  KEY `license` (`license`)
) ENGINE=InnoDB AUTO_INCREMENT=3985 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

-- elused.players: ~21 rows (yaklaşık) tablosu için veriler indiriliyor
DELETE FROM `players`;
INSERT INTO `players` (`id`, `citizenid`, `cid`, `license`, `name`, `money`, `charinfo`, `job`, `gang`, `position`, `metadata`, `inventory`, `last_updated`, `iban`, `pincode`, `daily`, `aranma`, `photo`, `photos`, `apps`, `widget`, `bt`, `cryptocurrency`, `cryptocurrencytransfers`, `phonePos`, `spotify`, `ringtone`, `first_screen_showed`, `disabled`, `phone_number`, `skills`) VALUES
	...
	(1367, 'BMS02698', 1, 'license:52b101e073da3b76bb2218931ce6fb5e38c2bd69', 'RedViper', '{"blackmoney":0,"crypto":0,"cash":235090.0,"bank":264969}', '{"gender":0,"cid":1,"birthdate":"2024-01-08","nationality":"182","phone":"429841","firstname":"VADİM ","backstory":"placeholder backstory","account":"87800258536","lastname":"CANTAS"}', '{"name":"taxi","isboss":false,"onduty":true,"grade":{"name":"Çalışan","level":0},"label":"Taksici","type":"none","payment":25}', '{"name":"none","isboss":false,"grade":{"name":"none","level":0},"label":"No Gang Affiliaton"}', '{"x":-321.5604248046875,"y":-128.980224609375,"z":39.002197265625}', '{"jailitems":[],"fitbit":[],"walletid":"9261","fingerprint":"Ts438g74ayB7528","hunger":78.99999999999636,"communityservice":0,"callsign":"NO CALLSIGN","commandbinds":[],"skill":{"Kondisyon":{"RemoveAmount":0,"Menu":true,"Current":10.07999999999999,"Stat":"MP0_STAMINA"},"Ciğer Kapasitesi":{"RemoveAmount":0,"Menu":true,"Current":5.39999999999999,"Stat":"MP0_LUNG_CAPACITY"},"Güç":{"RemoveAmount":0,"Menu":true,"Current":5,"Stat":"MP0_STRENGTH"},"Sürüş Yeteneği":{"RemoveAmount":0,"Menu":true,"Current":5.09999999999998,"Stat":"MP0_DRIVING_ABILITY"},"Ön Kaldırma Yeteneği":{"RemoveAmount":0,"Menu":true,"Current":0,"Stat":"MP0_WHEELIE_ABILITY"}},"pkelepce":false,"thirst":80.99999999999909,"jobrep":{"trucker":0,"taxi":0,"tow":0,"hotdog":0},"attachmentcraftingrep":0,"criminalrecord":{"hasRecord":false},"dealerrep":0,"phonedata":{"SerialNumber":7661,"InstalledApps":[]},"stress":0,"tracker":false,"bloodtype":"A-","armor":0,"kelepce":false,"ishandcuffed":false,"licences":{"driver":true,"weapon":false,"business":false},"status":[],"injail":0,"phone":[],"inside":{"apartment":[]},"craftingrep":0,"inlaststand":false,"isdead":false}', '[{"type":"item","name":"cash","slot":1,"info":[],"amount":235090.0},{"type":"weapon","name":"weapon_heavypistol","slot":2,"info":{"serie":"68Uhp7nH464lXXj","quality":79.30000000000314,"ammo":220},"amount":1},{"type":"item","name":"fishingrod1","slot":5,"info":[],"amount":1},{"type":"item","name":"bottle","slot":6,"info":[],"amount":1},{"type":"item","name":"anchovy","slot":7,"info":[],"amount":1},{"type":"weapon","name":"weapon_vintagepistol","slot":8,"info":{"serie":"55NQC5TC659IdcS","quality":4.60000000001445,"ammo":0},"amount":1}]', '2024-02-02 00:38:44', 'QB8442', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '429841', '{"Diving":{"Current":0,"RemoveAmount":0,"Stat":"DIVING_ABILITY","icon":"fas fa-water"},"Wheelie":{"Current":0,"RemoveAmount":-0.2,"Stat":"MP0_WHEELIE_ABILITY","icon":"fas fa-wheelchair"},"Driving":{"Current":0,"RemoveAmount":-0.5,"Stat":"MP0_DRIVING_ABILITY","icon":"fas fa-car-side"},"Street Reputation":{"Current":0,"RemoveAmount":0,"Stat":"DRUGREP_ABILITY","icon":"fas fa-cannabis"},"Searching":{"Current":0,"RemoveAmount":0,"Stat":"BINDIVE_ABILITY","icon":"fas fa-trash"},"Strength":{"Current":0,"RemoveAmount":-0.3,"Stat":"MP0_STRENGTH","icon":"fas fa-dumbbell"},"Drug Manufacture":{"Current":0,"RemoveAmount":0,"Stat":"DRUGMAKE_ABILITY","icon":"fas fa-pills"},"Scraping":{"Current":0,"RemoveAmount":0,"Stat":"SCRAP_ABILITY","icon":"fas fa-screwdriver"},"Stamina":{"Current":0,"RemoveAmount":-0.3,"Stat":"MP0_STAMINA","icon":"fas fa-walking"},"Shooting":{"Current":0,"RemoveAmount":-0.1,"Stat":"MP0_SHOOTING_ABILITY","icon":"fas fa-bullseye"},"Sprint Driving":{"Current":0,"RemoveAmount":0,"Stat":"DRIVER_ABILITY","icon":"fas fa-car-alt"},"Lumberjack":{"Current":0,"RemoveAmount":0,"Stat":"TREE_ABILITY","icon":"fas fa-tree"},"Electrical":{"Current":0,"RemoveAmount":0,"Stat":"ELECTRICAL_ABILITY","icon":"fas fa-bolt"},"Delivery Runner":{"Current":0,"RemoveAmount":0,"Stat":"RUNNER_ABILITY","icon":"fas fa-car"},"Lung Capacity":{"Current":0,"RemoveAmount":-0.1,"Stat":"MP0_LUNG_CAPACITY","icon":"fas fa-heartbeat"},"Heist Reputation":{"Current":0,"RemoveAmount":0,"Stat":"HEIST_ABILITY","icon":"fa-solid fa-user-secret"},"Hitman":{"Current":0,"RemoveAmount":0,"Stat":"HITMAN_ABILITY","icon":"fas fa-skull"},"Hacking":{"Current":0,"RemoveAmount":0,"Stat":"HACK_ABILITY","icon":"fas fa-laptop-code"}}'),
	(3257, 'CDR37384', 1, 'license:759f35b0a5e54b71040546417277a6471bac20df', 'Efe keskin', '{"bank":97175585,"blackmoney":0,"crypto":0,"cash":0}', '{"account":"92451175313","cid":1,"nationality":"Türkiye","gender":0,"birthdate":"1997-05-05","phone":"677991","firstname":"Swex ","lastname":"Toe","backstory":"placeholder backstory"}', '{"label":"LSPD","isboss":true,"grade":{"name":"Ast. Chief","level":15},"onduty":true,"type":"leo","name":"police","payment":5000}', '{"isboss":false,"grade":{"name":"none","level":0},"name":"none","label":"No Gang Affiliaton"}', '{"x":485.3670349121094,"y":-996.8571166992188,"z":30.6783447265625}', '{"injail":0,"communityservice":0,"commandbinds":[],"isdead":false,"armor":0,"craftingrep":0,"inside":{"apartment":[]},"attachmentcraftingrep":0,"licences":{"weapon":false,"driver":true,"business":false},"pkelepce":false,"walletid":"3873","status":[],"hunger":28.59999999998763,"skill":{"Ön Kaldırma Yeteneği":{"RemoveAmount":0,"Menu":true,"Current":0,"Stat":"MP0_WHEELIE_ABILITY"},"Güç":{"RemoveAmount":0,"Menu":true,"Current":5,"Stat":"MP0_STRENGTH"},"Sürüş Yeteneği":{"RemoveAmount":0,"Menu":true,"Current":1.69999999999999,"Stat":"MP0_DRIVING_ABILITY"},"Ciğer Kapasitesi":{"RemoveAmount":0,"Menu":true,"Current":5.29999999999999,"Stat":"MP0_LUNG_CAPACITY"},"Kondisyon":{"RemoveAmount":0,"Menu":true,"Current":10.05999999999999,"Stat":"MP0_STAMINA"}},"fingerprint":"nW481C86ibg4380","tracker":false,"callsign":"NO CALLSIGN","criminalrecord":{"hasRecord":false},"ishandcuffed":false,"fitbit":[],"phone":[],"dealerrep":0,"jailitems":[],"bloodtype":"A+","kelepce":false,"inlaststand":false,"jobrep":{"trucker":0,"taxi":0,"tow":0,"hotdog":0},"stress":0,"phonedata":{"InstalledApps":[],"SerialNumber":4607},"thirst":35.39999999999691}', '[{"type":"item","name":"pkelepceanahtar","amount":1,"slot":1,"info":[]},{"type":"weapon","name":"weapon_hk416","amount":1,"slot":2,"info":{"ammo":22,"quality":57.25000000000648,"attachments":[],"serie":""}},{"type":"weapon","name":"weapon_beanbagshotgun","amount":1,"slot":3,"info":{"ammo":62,"quality":100.0,"serie":"74SoV1yN624Nrak"}},{"type":"item","name":"rifle_ammo","amount":42,"slot":4,"info":[]},{"type":"item","name":"pkelepce","amount":1,"slot":6,"info":[]},{"type":"item","name":"megaphone","amount":1,"slot":9,"info":[]}]', '2024-02-01 21:29:44', NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '677991', '{"Diving":{"Stat":"DIVING_ABILITY","Current":0,"RemoveAmount":0,"icon":"fas fa-water"},"Street Reputation":{"Stat":"DRUGREP_ABILITY","Current":0,"RemoveAmount":0,"icon":"fas fa-cannabis"},"Searching":{"Stat":"BINDIVE_ABILITY","Current":0,"RemoveAmount":0,"icon":"fas fa-trash"},"Hacking":{"Stat":"HACK_ABILITY","Current":0,"RemoveAmount":0,"icon":"fas fa-laptop-code"},"Heist Reputation":{"Stat":"HEIST_ABILITY","Current":0,"RemoveAmount":0,"icon":"fa-solid fa-user-secret"},"Lung Capacity":{"Stat":"MP0_LUNG_CAPACITY","Current":0,"RemoveAmount":-0.1,"icon":"fas fa-heartbeat"},"Hitman":{"Stat":"HITMAN_ABILITY","Current":0,"RemoveAmount":0,"icon":"fas fa-skull"},"Shooting":{"Stat":"MP0_SHOOTING_ABILITY","Current":0,"RemoveAmount":-0.1,"icon":"fas fa-bullseye"},"Scraping":{"Stat":"SCRAP_ABILITY","Current":0,"RemoveAmount":0,"icon":"fas fa-screwdriver"},"Strength":{"Stat":"MP0_STRENGTH","Current":0,"RemoveAmount":-0.3,"icon":"fas fa-dumbbell"},"Stamina":{"Stat":"MP0_STAMINA","Current":0,"RemoveAmount":-0.3,"icon":"fas fa-walking"},"Sprint Driving":{"Stat":"DRIVER_ABILITY","Current":0,"RemoveAmount":0,"icon":"fas fa-car-alt"},"Drug Manufacture":{"Stat":"DRUGMAKE_ABILITY","Current":0,"RemoveAmount":0,"icon":"fas fa-pills"},"Wheelie":{"Stat":"MP0_WHEELIE_ABILITY","Current":0,"RemoveAmount":-0.2,"icon":"fas fa-wheelchair"},"Lumberjack":{"Stat":"TREE_ABILITY","Current":0,"RemoveAmount":0,"icon":"fas fa-tree"},"Driving":{"Stat":"MP0_DRIVING_ABILITY","Current":0,"RemoveAmount":-0.5,"icon":"fas fa-car-side"},"Electrical":{"Stat":"ELECTRICAL_ABILITY","Current":0,"RemoveAmount":0,"icon":"fas fa-bolt"},"Delivery Runner":{"Stat":"RUNNER_ABILITY","Current":0,"RemoveAmount":0,"icon":"fas fa-car"}}'),
	...
	(2999, 'DXH34648', 1, 'license:987ed547c73270ca6274c4ee61400b5dbcc85e4c', 'BlueFail18', '{"bank":800050,"blackmoney":0,"crypto":0,"cash":5545}', '{"account":"79247135636","cid":1,"nationality":"USA","gender":0,"birthdate":"1990-05-25","phone":"756765","firstname":"Walter","lastname":"Black","backstory":"placeholder backstory"}', '{"label":"LSPD","isboss":true,"grade":{"name":"Cheif Of Police","level":16},"onduty":true,"type":"leo","name":"police","payment":5000}', '{"isboss":false,"grade":{"name":"none","level":0},"name":"none","label":"No Gang Affiliaton"}', '{"x":-26.61098670959472,"y":-1079.9208984375,"z":29.2799072265625}', '{"injail":0,"communityservice":0,"commandbinds":[],"isdead":false,"armor":0,"skill":{"Ön Kaldırma Yeteneği":{"Current":0,"Menu":true,"RemoveAmount":0,"Stat":"MP0_WHEELIE_ABILITY"},"Güç":{"Current":5,"Menu":true,"RemoveAmount":0,"Stat":"MP0_STRENGTH"},"Sürüş Yeteneği":{"Current":1.69999999999999,"Menu":true,"RemoveAmount":0,"Stat":"MP0_DRIVING_ABILITY"},"Ciğer Kapasitesi":{"Current":5.39999999999999,"Menu":true,"RemoveAmount":0,"Stat":"MP0_LUNG_CAPACITY"},"Kondisyon":{"Current":10.07999999999999,"Menu":true,"RemoveAmount":0,"Stat":"MP0_STAMINA"}},"inside":{"apartment":[]},"attachmentcraftingrep":0,"licences":{"weapon":false,"business":false,"driver":true},"pkelepce":false,"walletid":"7403","status":[],"hunger":78.99999999999636,"kelepce":false,"fingerprint":"zT801N97LEh9535","criminalrecord":{"hasRecord":false},"callsign":"NO CALLSIGN","craftingrep":0,"ishandcuffed":false,"fitbit":[],"thirst":80.99999999999909,"dealerrep":0,"jailitems":[],"bloodtype":"A+","phone":[],"inlaststand":false,"jobrep":{"taxi":0,"trucker":0,"tow":0,"hotdog":0},"stress":0,"phonedata":{"InstalledApps":[],"SerialNumber":5196},"tracker":false}', '[{"type":"weapon","name":"weapon_m9","amount":1,"slot":1,"info":{"ammo":233,"quality":13.45000000001312,"serie":"42IFr0px501IoSX"}},{"type":"weapon","name":"weapon_ak47","amount":1,"slot":2,"info":{"ammo":190,"quality":75.70000000000369,"serie":"27kRz2hM878DyPc"}},{"type":"item","name":"heavyarmor","amount":13,"slot":3,"info":[]},{"type":"item","name":"bandage","amount":14,"slot":4,"info":[]},{"type":"weapon","name":"weapon_scarh","amount":1,"slot":5,"info":{"ammo":237,"quality":96.7000000000005,"serie":"96SZx2lN010acyd"}},{"type":"item","name":"cash","amount":5545,"slot":6,"info":[]},{"type":"item","name":"pistol_ammo","amount":32,"slot":7,"info":[]},{"type":"item","name":"rifle_ammo","amount":2,"slot":8,"info":[]},{"type":"weapon","name":"weapon_appistol","amount":1,"slot":10,"info":{"ammo":14,"quality":76.9000000000035,"serie":"08Mby8hL994GlPM"}},{"type":"item","name":"pkelepce","amount":5,"slot":13,"info":[]}]', '2024-02-01 22:12:51', NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '756765', '{"Scraping":{"Current":0,"icon":"fas fa-screwdriver","RemoveAmount":0,"Stat":"SCRAP_ABILITY"},"Delivery Runner":{"Current":0,"icon":"fas fa-car","RemoveAmount":0,"Stat":"RUNNER_ABILITY"},"Strength":{"Current":0,"icon":"fas fa-dumbbell","RemoveAmount":-0.3,"Stat":"MP0_STRENGTH"},"Wheelie":{"Current":0,"icon":"fas fa-wheelchair","RemoveAmount":-0.2,"Stat":"MP0_WHEELIE_ABILITY"},"Lung Capacity":{"Current":0.7,"icon":"fas fa-heartbeat","RemoveAmount":-0.1,"Stat":"MP0_LUNG_CAPACITY"},"Sprint Driving":{"Current":0,"icon":"fas fa-car-alt","RemoveAmount":0,"Stat":"DRIVER_ABILITY"},"Hacking":{"Current":0,"icon":"fas fa-laptop-code","RemoveAmount":0,"Stat":"HACK_ABILITY"},"Hitman":{"Current":0,"icon":"fas fa-skull","RemoveAmount":0,"Stat":"HITMAN_ABILITY"},"Electrical":{"Current":0,"icon":"fas fa-bolt","RemoveAmount":0,"Stat":"ELECTRICAL_ABILITY"},"Searching":{"Current":0,"icon":"fas fa-trash","RemoveAmount":0,"Stat":"BINDIVE_ABILITY"},"Heist Reputation":{"Current":0,"icon":"fa-solid fa-user-secret","RemoveAmount":0,"Stat":"HEIST_ABILITY"},"Lumberjack":{"Current":0,"icon":"fas fa-tree","RemoveAmount":0,"Stat":"TREE_ABILITY"},"Driving":{"Current":0,"icon":"fas fa-car-side","RemoveAmount":-0.5,"Stat":"MP0_DRIVING_ABILITY"},"Shooting":{"Current":0,"icon":"fas fa-bullseye","RemoveAmount":-0.1,"Stat":"MP0_SHOOTING_ABILITY"},"Street Reputation":{"Current":0,"icon":"fas fa-cannabis","RemoveAmount":0,"Stat":"DRUGREP_ABILITY"},"Drug Manufacture":{"Current":0,"icon":"fas fa-pills","RemoveAmount":0,"Stat":"DRUGMAKE_ABILITY"},"Stamina":{"Current":0,"icon":"fas fa-walking","RemoveAmount":-0.3,"Stat":"MP0_STAMINA"},"Diving":{"Current":0,"icon":"fas fa-water","RemoveAmount":0,"Stat":"DIVING_ABILITY"}}'),
	...
	(1458, 'HGO75866', 1, 'license:21f668b3835e9bcd1f243a28d0ee5358330f41f6', 'Eymenp06', '{"bank":15140,"blackmoney":0,"cash":10005950,"crypto":0}', '{"gender":0,"nationality":"İngiliz","account":"42671790688","lastname":"Edison","birthdate":"2000-03-03","cid":1,"backstory":"placeholder backstory","firstname":"Tommy","phone":"518937"}', '{"name":"police","payment":5000,"label":"LSPD","isboss":true,"grade":{"name":"Ast. Chief","level":15},"onduty":true,"type":"leo"}', '{"name":"none","grade":{"name":"none","level":0},"isboss":false,"label":"No Gang Affiliaton"}', '{"x":-491.1692199707031,"y":-177.95603942871095,"z":36.980224609375}', '{"inlaststand":false,"stress":0,"ishandcuffed":false,"armor":0,"bloodtype":"O+","callsign":"NO CALLSIGN","attachmentcraftingrep":0,"jailitems":[],"commandbinds":[],"fingerprint":"dv160X08mwW8688","walletid":"2653","tracker":false,"skill":{"Ön Kaldırma Yeteneği":{"Current":0,"Stat":"MP0_WHEELIE_ABILITY","Menu":true,"RemoveAmount":0},"Sürüş Yeteneği":{"Current":0.2,"Stat":"MP0_DRIVING_ABILITY","Menu":true,"RemoveAmount":0},"Güç":{"Current":5,"Stat":"MP0_STRENGTH","Menu":true,"RemoveAmount":0},"Kondisyon":{"Current":10,"Stat":"MP0_STAMINA","Menu":true,"RemoveAmount":0},"Ciğer Kapasitesi":{"Current":5,"Stat":"MP0_LUNG_CAPACITY","Menu":true,"RemoveAmount":0}},"thirst":73.39999999999873,"isdead":false,"inside":{"apartment":[]},"kelepce":false,"fitbit":[],"pkelepce":false,"injail":0,"status":[],"hunger":70.5999999999949,"phonedata":{"SerialNumber":9943,"InstalledApps":[]},"dealerrep":0,"craftingrep":0,"jobrep":{"trucker":0,"hotdog":0,"taxi":0,"tow":0},"communityservice":0,"criminalrecord":{"hasRecord":false},"licences":{"business":false,"weapon":false,"driver":true},"phone":[]}', '[{"slot":1,"info":{"serie":"41HyP8Cx624oSwu","quality":87.85000000000184,"ammo":204},"type":"weapon","amount":1,"name":"weapon_appistol"},{"slot":2,"info":[],"type":"item","amount":21,"name":"pistol_ammo"},{"slot":3,"info":[],"type":"item","amount":1,"name":"megaphone"},{"slot":6,"info":{"serie":"03kav9mi859Efnj","quality":100,"ammo":0},"type":"weapon","amount":1,"name":"weapon_nightstick"},{"slot":8,"info":[],"type":"item","amount":1,"name":"pkelepceanahtar"},{"slot":9,"info":[],"type":"item","amount":5,"name":"pkelepce"},{"slot":21,"info":[],"type":"item","amount":10005950,"name":"cash"},{"slot":12,"info":[],"type":"item","amount":1,"name":"badge"}]', '2024-02-01 17:56:34', NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '518937', '{"Diving":{"icon":"fas fa-water","RemoveAmount":0,"Stat":"DIVING_ABILITY","Current":0},"Electrical":{"icon":"fas fa-bolt","RemoveAmount":0,"Stat":"ELECTRICAL_ABILITY","Current":0},"Hacking":{"icon":"fas fa-laptop-code","RemoveAmount":0,"Stat":"HACK_ABILITY","Current":0},"Street Reputation":{"icon":"fas fa-cannabis","RemoveAmount":0,"Stat":"DRUGREP_ABILITY","Current":0},"Sprint Driving":{"icon":"fas fa-car-alt","RemoveAmount":0,"Stat":"DRIVER_ABILITY","Current":0},"Delivery Runner":{"icon":"fas fa-car","RemoveAmount":0,"Stat":"RUNNER_ABILITY","Current":0},"Wheelie":{"icon":"fas fa-wheelchair","RemoveAmount":-0.2,"Stat":"MP0_WHEELIE_ABILITY","Current":0},"Drug Manufacture":{"icon":"fas fa-pills","RemoveAmount":0,"Stat":"DRUGMAKE_ABILITY","Current":0},"Shooting":{"icon":"fas fa-bullseye","RemoveAmount":-0.1,"Stat":"MP0_SHOOTING_ABILITY","Current":0},"Lung Capacity":{"icon":"fas fa-heartbeat","RemoveAmount":-0.1,"Stat":"MP0_LUNG_CAPACITY","Current":0},"Scraping":{"icon":"fas fa-screwdriver","RemoveAmount":0,"Stat":"SCRAP_ABILITY","Current":0},"Stamina":{"icon":"fas fa-walking","RemoveAmount":-0.3,"Stat":"MP0_STAMINA","Current":0},"Searching":{"icon":"fas fa-trash","RemoveAmount":0,"Stat":"BINDIVE_ABILITY","Current":0},"Heist Reputation":{"icon":"fa-solid fa-user-secret","RemoveAmount":0,"Stat":"HEIST_ABILITY","Current":0},"Hitman":{"icon":"fas fa-skull","RemoveAmount":0,"Stat":"HITMAN_ABILITY","Current":0},"Lumberjack":{"icon":"fas fa-tree","RemoveAmount":0,"Stat":"TREE_ABILITY","Current":0},"Driving":{"icon":"fas fa-car-side","RemoveAmount":-0.5,"Stat":"MP0_DRIVING_ABILITY","Current":0.1},"Strength":{"icon":"fas fa-dumbbell","RemoveAmount":-0.3,"Stat":"MP0_STRENGTH","Current":0}}'),
	(2782, 'HTB94113', 1, 'license:93d12f54207d0e7f6451b8a015c3a16597e70ff6', 'AM SORİ GOTODE', '{"blackmoney":0,"bank":2860,"cash":8000,"crypto":0}', '{"backstory":"placeholder backstory","lastname":"Morgan","nationality":"türk","gender":0,"birthdate":"2024-01-27","account":"59425862560","cid":1,"phone":"837963","firstname":"Arthur"}', '{"grade":{"name":"Freelancer","level":0},"payment":10,"label":"Civilian","name":"unemployed","type":"none","isboss":false,"onduty":true}', '{"name":"none","isboss":false,"grade":{"name":"none","level":0},"label":"No Gang Affiliaton"}', '{"x":-48.13186645507812,"y":-1095.4813232421876,"z":26.4154052734375}', '{"hunger":95.79999999999927,"attachmentcraftingrep":0,"skill":{"Güç":{"Menu":true,"Current":5,"Stat":"MP0_STRENGTH","RemoveAmount":0},"Ön Kaldırma Yeteneği":{"Menu":true,"Current":0,"Stat":"MP0_WHEELIE_ABILITY","RemoveAmount":0},"Ciğer Kapasitesi":{"Menu":true,"Current":5,"Stat":"MP0_LUNG_CAPACITY","RemoveAmount":0},"Sürüş Yeteneği":{"Menu":true,"Current":0.6,"Stat":"MP0_DRIVING_ABILITY","RemoveAmount":0},"Kondisyon":{"Menu":true,"Current":10,"Stat":"MP0_STAMINA","RemoveAmount":0}},"dealerrep":0,"status":[],"stress":0,"commandbinds":[],"isdead":false,"criminalrecord":{"hasRecord":false},"licences":{"weapon":false,"driver":true,"business":false},"communityservice":0,"inside":{"apartment":[]},"jailitems":[],"tracker":false,"inlaststand":false,"armor":0,"ishandcuffed":false,"walletid":"1140","fingerprint":"bB372R73uOe7433","jobrep":{"tow":0,"hotdog":0,"taxi":0,"trucker":0},"callsign":"NO CALLSIGN","pkelepce":false,"phone":[],"fitbit":[],"kelepce":false,"thirst":96.19999999999982,"bloodtype":"B+","phonedata":{"SerialNumber":9502,"InstalledApps":[]},"craftingrep":0,"injail":0}', '[{"type":"item","name":"cash","amount":8000,"slot":1,"info":[]},{"type":"item","name":"phone","amount":1,"slot":2,"info":[]},{"type":"item","name":"id_card","amount":1,"slot":3,"info":{"nationality":"türk","birthdate":"2024-01-27","lastname":"Morgan","gender":0,"firstname":"Arthur","citizenid":"HTB94113"}},{"type":"item","name":"driver_license","amount":1,"slot":4,"info":{"firstname":"Arthur","type":"Class C Driver License","birthdate":"2024-01-27","lastname":"Morgan"}},{"type":"item","name":"water_bottle","amount":1,"slot":5,"info":[]}]', '2024-01-27 13:53:18', NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '837963', '{"Hitman":{"icon":"fas fa-skull","RemoveAmount":0,"Stat":"HITMAN_ABILITY","Current":0},"Delivery Runner":{"icon":"fas fa-car","RemoveAmount":0,"Stat":"RUNNER_ABILITY","Current":0},"Searching":{"icon":"fas fa-trash","RemoveAmount":0,"Stat":"BINDIVE_ABILITY","Current":0},"Sprint Driving":{"icon":"fas fa-car-alt","RemoveAmount":0,"Stat":"DRIVER_ABILITY","Current":0},"Lumberjack":{"icon":"fas fa-tree","RemoveAmount":0,"Stat":"TREE_ABILITY","Current":0},"Stamina":{"icon":"fas fa-walking","RemoveAmount":-0.3,"Stat":"MP0_STAMINA","Current":0},"Wheelie":{"icon":"fas fa-wheelchair","RemoveAmount":-0.2,"Stat":"MP0_WHEELIE_ABILITY","Current":0},"Strength":{"icon":"fas fa-dumbbell","RemoveAmount":-0.3,"Stat":"MP0_STRENGTH","Current":0},"Heist Reputation":{"icon":"fa-solid fa-user-secret","RemoveAmount":0,"Stat":"HEIST_ABILITY","Current":0},"Driving":{"icon":"fas fa-car-side","RemoveAmount":-0.5,"Stat":"MP0_DRIVING_ABILITY","Current":0.2},"Lung Capacity":{"icon":"fas fa-heartbeat","RemoveAmount":-0.1,"Stat":"MP0_LUNG_CAPACITY","Current":0},"Street Reputation":{"icon":"fas fa-cannabis","RemoveAmount":0,"Stat":"DRUGREP_ABILITY","Current":0},"Shooting":{"icon":"fas fa-bullseye","RemoveAmount":-0.1,"Stat":"MP0_SHOOTING_ABILITY","Current":0},"Scraping":{"icon":"fas fa-screwdriver","RemoveAmount":0,"Stat":"SCRAP_ABILITY","Current":0},"Diving":{"icon":"fas fa-water","RemoveAmount":0,"Stat":"DIVING_ABILITY","Current":0},"Drug Manufacture":{"icon":"fas fa-pills","RemoveAmount":0,"Stat":"DRUGMAKE_ABILITY","Current":0},"Hacking":{"icon":"fas fa-laptop-code","RemoveAmount":0,"Stat":"HACK_ABILITY","Current":0},"Electrical":{"icon":"fas fa-bolt","RemoveAmount":0,"Stat":"ELECTRICAL_ABILITY","Current":0}}'),
	...
	(3387, 'PAE72962', 1, 'license:1b08d417a013b97236eb4941ed577c2aa22f4973', 'DRAGON', '{"cash":87531,"blackmoney":0,"bank":49075,"crypto":0}', '{"birthdate":"2024-02-01","account":"54049857018","cid":1,"lastname":"A","phone":"839901","backstory":"placeholder backstory","gender":0,"firstname":"V","nationality":"A"}', '{"grade":{"level":0,"name":"Çalışan"},"label":"Taksici","onduty":true,"isboss":false,"type":"none","payment":25,"name":"taxi"}', '{"isboss":false,"name":"none","grade":{"level":0,"name":"none"},"label":"No Gang Affiliaton"}', '{"x":-3831.9296875,"y":-1970.3736572265626,"z":2.23583984375}', '{"stress":0,"status":[],"callsign":"NO CALLSIGN","phonedata":{"SerialNumber":9106,"InstalledApps":[]},"attachmentcraftingrep":0,"inlaststand":false,"phone":[],"jailitems":[],"ishandcuffed":false,"commandbinds":[],"pkelepce":false,"licences":{"driver":true,"business":false,"weapon":false},"fingerprint":"vT610c80uCG0151","thirst":50.59999999999763,"tracker":false,"inside":{"apartment":[]},"dealerrep":0,"skill":{"Sürüş Yeteneği":{"Stat":"MP0_DRIVING_ABILITY","RemoveAmount":0,"Menu":true,"Current":0.1},"Güç":{"Stat":"MP0_STRENGTH","RemoveAmount":0,"Menu":true,"Current":5},"Ön Kaldırma Yeteneği":{"Stat":"MP0_WHEELIE_ABILITY","RemoveAmount":0,"Menu":true,"Current":0},"Ciğer Kapasitesi":{"Stat":"MP0_LUNG_CAPACITY","RemoveAmount":0,"Menu":true,"Current":5},"Kondisyon":{"Stat":"MP0_STAMINA","RemoveAmount":0,"Menu":true,"Current":10}},"hunger":45.39999999999054,"walletid":"7440","criminalrecord":{"hasRecord":false},"fitbit":[],"craftingrep":0,"bloodtype":"AB+","armor":0,"communityservice":0,"jobrep":{"taxi":0,"hotdog":0,"trucker":0,"tow":0},"injail":0,"isdead":false,"kelepce":false}', '[{"info":[],"slot":1,"amount":87531,"type":"item","name":"cash"},{"info":[],"slot":2,"amount":1,"type":"item","name":"fishingrod1"},{"info":[],"slot":3,"amount":9,"type":"item","name":"illegalfishbait"},{"info":[],"slot":4,"amount":2,"type":"item","name":"anchovy"},{"info":[],"slot":5,"amount":1,"type":"item","name":"fishingrod5"}]', '2024-02-02 06:15:52', NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '839901', '{"Strength":{"Stat":"MP0_STRENGTH","Current":0,"RemoveAmount":-0.3,"icon":"fas fa-dumbbell"},"Sprint Driving":{"Stat":"DRIVER_ABILITY","Current":0,"RemoveAmount":0,"icon":"fas fa-car-alt"},"Searching":{"Stat":"BINDIVE_ABILITY","Current":0,"RemoveAmount":0,"icon":"fas fa-trash"},"Street Reputation":{"Stat":"DRUGREP_ABILITY","Current":0,"RemoveAmount":0,"icon":"fas fa-cannabis"},"Electrical":{"Stat":"ELECTRICAL_ABILITY","Current":0,"RemoveAmount":0,"icon":"fas fa-bolt"},"Wheelie":{"Stat":"MP0_WHEELIE_ABILITY","Current":0,"RemoveAmount":-0.2,"icon":"fas fa-wheelchair"},"Driving":{"Stat":"MP0_DRIVING_ABILITY","Current":0,"RemoveAmount":-0.5,"icon":"fas fa-car-side"},"Shooting":{"Stat":"MP0_SHOOTING_ABILITY","Current":0,"RemoveAmount":-0.1,"icon":"fas fa-bullseye"},"Hacking":{"Stat":"HACK_ABILITY","Current":0,"RemoveAmount":0,"icon":"fas fa-laptop-code"},"Heist Reputation":{"Stat":"HEIST_ABILITY","Current":0,"RemoveAmount":0,"icon":"fa-solid fa-user-secret"},"Lumberjack":{"Stat":"TREE_ABILITY","Current":0,"RemoveAmount":0,"icon":"fas fa-tree"},"Scraping":{"Stat":"SCRAP_ABILITY","Current":0,"RemoveAmount":0,"icon":"fas fa-screwdriver"},"Delivery Runner":{"Stat":"RUNNER_ABILITY","Current":0,"RemoveAmount":0,"icon":"fas fa-car"},"Drug Manufacture":{"Stat":"DRUGMAKE_ABILITY","Current":0,"RemoveAmount":0,"icon":"fas fa-pills"},"Stamina":{"Stat":"MP0_STAMINA","Current":0,"RemoveAmount":-0.3,"icon":"fas fa-walking"},"Diving":{"Stat":"DIVING_ABILITY","Current":0,"RemoveAmount":0,"icon":"fas fa-water"},"Hitman":{"Stat":"HITMAN_ABILITY","Current":0,"RemoveAmount":0,"icon":"fas fa-skull"},"Lung Capacity":{"Stat":"MP0_LUNG_CAPACITY","Current":0,"RemoveAmount":-0.1,"icon":"fas fa-heartbeat"}}'),
	...
	(3683, 'WZB65598', 1, 'license:e0583589f7ca5650689105802df0bd4975d2d06f', 'Kaslızenci', '{"cash":2780,"blackmoney":0,"crypto":0,"bank":3520}', '{"firstname":"Sabri","cid":1,"nationality":"kürdistan","gender":0,"birthdate":"2024-02-06","account":"13667140657","phone":"117948","lastname":"soyan","backstory":"placeholder backstory"}', '{"label":"Civilian","onduty":true,"grade":{"name":"Freelancer","level":0},"payment":10,"type":"none","name":"unemployed","isboss":false}', '{"label":"No Gang Affiliaton","grade":{"name":"none","level":0},"name":"none","isboss":false}', '{"x":397.22637939453127,"y":-970.6417846679688,"z":28.6226806640625}', '{"injail":0,"communityservice":0,"kelepce":false,"tracker":false,"armor":0,"skill":{"Ön Kaldırma Yeteneği":{"RemoveAmount":0,"Menu":true,"Current":0,"Stat":"MP0_WHEELIE_ABILITY"},"Güç":{"RemoveAmount":0,"Menu":true,"Current":5,"Stat":"MP0_STRENGTH"},"Sürüş Yeteneği":{"RemoveAmount":0,"Menu":true,"Current":0.4,"Stat":"MP0_DRIVING_ABILITY"},"Ciğer Kapasitesi":{"RemoveAmount":0,"Menu":true,"Current":5,"Stat":"MP0_LUNG_CAPACITY"},"Kondisyon":{"RemoveAmount":0,"Menu":true,"Current":10,"Stat":"MP0_STAMINA"}},"inside":{"apartment":[]},"attachmentcraftingrep":0,"phonedata":{"InstalledApps":[],"SerialNumber":1386},"pkelepce":false,"walletid":"1542","status":[],"hunger":78.99999999999636,"commandbinds":[],"fingerprint":"wm608W47mOd6981","criminalrecord":{"hasRecord":false},"callsign":"NO CALLSIGN","thirst":80.99999999999909,"ishandcuffed":false,"fitbit":[],"stress":0,"dealerrep":0,"jailitems":[],"bloodtype":"A-","phone":[],"inlaststand":false,"jobrep":{"taxi":0,"trucker":0,"tow":0,"hotdog":0},"isdead":false,"licences":{"weapon":false,"driver":true,"business":false},"craftingrep":0}', '[{"type":"item","name":"fishingrod1","amount":1,"slot":1,"info":[]},{"type":"item","name":"illegalfishbait","amount":10,"slot":2,"info":[]},{"type":"item","name":"fishbait","amount":39,"slot":4,"info":[]},{"type":"item","name":"driver_license","amount":1,"slot":6,"info":{"firstname":"Sabri","type":"Class C Driver License","birthdate":"2024-02-06","lastname":"soyan"}},{"type":"item","name":"phone","amount":1,"slot":7,"info":[]},{"type":"item","name":"cash","amount":2780,"slot":8,"info":[]},{"type":"item","name":"id_card","amount":1,"slot":9,"info":{"firstname":"Sabri","nationality":"kürdistan","gender":0,"lastname":"soyan","birthdate":"2024-02-06","citizenid":"WZB65598"}}]', '2024-02-01 21:10:12', NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '117948', '{"Diving":{"Stat":"DIVING_ABILITY","icon":"fas fa-water","RemoveAmount":0,"Current":0},"Lung Capacity":{"Stat":"MP0_LUNG_CAPACITY","icon":"fas fa-heartbeat","RemoveAmount":-0.1,"Current":0},"Lumberjack":{"Stat":"TREE_ABILITY","icon":"fas fa-tree","RemoveAmount":0,"Current":0},"Delivery Runner":{"Stat":"RUNNER_ABILITY","icon":"fas fa-car","RemoveAmount":0,"Current":0},"Drug Manufacture":{"Stat":"DRUGMAKE_ABILITY","icon":"fas fa-pills","RemoveAmount":0,"Current":0},"Hitman":{"Stat":"HITMAN_ABILITY","icon":"fas fa-skull","RemoveAmount":0,"Current":0},"Sprint Driving":{"Stat":"DRIVER_ABILITY","icon":"fas fa-car-alt","RemoveAmount":0,"Current":0},"Electrical":{"Stat":"ELECTRICAL_ABILITY","icon":"fas fa-bolt","RemoveAmount":0,"Current":0},"Strength":{"Stat":"MP0_STRENGTH","icon":"fas fa-dumbbell","RemoveAmount":-0.3,"Current":0},"Stamina":{"Stat":"MP0_STAMINA","icon":"fas fa-walking","RemoveAmount":-0.3,"Current":0},"Wheelie":{"Stat":"MP0_WHEELIE_ABILITY","icon":"fas fa-wheelchair","RemoveAmount":-0.2,"Current":0},"Searching":{"Stat":"BINDIVE_ABILITY","icon":"fas fa-trash","RemoveAmount":0,"Current":0},"Driving":{"Stat":"MP0_DRIVING_ABILITY","icon":"fas fa-car-side","RemoveAmount":-0.5,"Current":0},"Shooting":{"Stat":"MP0_SHOOTING_ABILITY","icon":"fas fa-bullseye","RemoveAmount":-0.1,"Current":0},"Heist Reputation":{"Stat":"HEIST_ABILITY","icon":"fa-solid fa-user-secret","RemoveAmount":0,"Current":0},"Hacking":{"Stat":"HACK_ABILITY","icon":"fas fa-laptop-code","RemoveAmount":0,"Current":0},"Scraping":{"Stat":"SCRAP_ABILITY","icon":"fas fa-screwdriver","RemoveAmount":0,"Current":0},"Street Reputation":{"Stat":"DRUGREP_ABILITY","icon":"fas fa-cannabis","RemoveAmount":0,"Current":0}}'),
	(1461, 'XRK76375', 1, 'license:579c4cc24ed4bb55b371e0fd1d553aa624337fd6', 'slaugh', '{"crypto":0,"bank":1100000048797,"blackmoney":0,"cash":29999989808178}', '{"account":"82569652951","birthdate":"2024-01-20","phone":"197265","lastname":"Crannell","firstname":"Daryl","nationality":"Fransız","cid":1,"gender":0,"backstory":"placeholder backstory"}', '{"grade":{"level":16,"name":"Cheif Of Police"},"label":"LSPD","isboss":true,"type":"leo","payment":5000,"name":"police","onduty":true}', '{"label":"No Gang Affiliaton","grade":{"level":0,"name":"none"},"isboss":false,"name":"none"}', '{"x":407.18243408203127,"y":-785.010986328125,"z":29.2967529296875}', '{"callsign":"NO CALLSIGN","commandbinds":[],"licences":{"driver":true,"weapon":false,"business":false},"fitbit":[],"walletid":"7248","injail":0,"attachmentcraftingrep":0,"dealerrep":0,"isdead":false,"pkelepce":false,"inside":{"apartment":[]},"stress":0,"craftingrep":0,"phonedata":{"InstalledApps":[],"SerialNumber":3645},"status":[],"fingerprint":"yr947L00uTN8695","armor":0,"skill":{"Sürüş Yeteneği":{"Stat":"MP0_DRIVING_ABILITY","Current":1.09999999999999,"Menu":true,"RemoveAmount":0},"Güç":{"Stat":"MP0_STRENGTH","Current":5,"Menu":true,"RemoveAmount":0},"Kondisyon":{"Stat":"MP0_STAMINA","Current":10.05999999999999,"Menu":true,"RemoveAmount":0},"Ön Kaldırma Yeteneği":{"Stat":"MP0_WHEELIE_ABILITY","Current":0.5,"Menu":true,"RemoveAmount":0},"Ciğer Kapasitesi":{"Stat":"MP0_LUNG_CAPACITY","Current":5.29999999999999,"Menu":true,"RemoveAmount":0}},"criminalrecord":{"hasRecord":false},"bloodtype":"B-","jobrep":{"tow":0,"hotdog":0,"trucker":0,"taxi":0},"kelepce":false,"jailitems":[],"thirst":80.99999999999909,"tracker":false,"ishandcuffed":false,"communityservice":0,"phone":[],"hunger":78.99999999999638,"inlaststand":false}', '[{"name":"fish","amount":1,"info":[],"slot":1,"type":"item"},{"name":"phone","amount":1,"info":[],"slot":2,"type":"item"},{"name":"anchovy","amount":1,"info":[],"slot":3,"type":"item"},{"name":"fishingrod4","amount":1,"info":[],"slot":5,"type":"item"},{"name":"cash","amount":29999989808178,"info":[],"slot":7,"type":"item"},{"name":"fishingrod1","amount":1,"info":[],"slot":12,"type":"item"},{"name":"weapon_scarh","amount":1,"info":{"quality":100,"ammo":-1,"serie":"52JwG7uq756ugxn"},"slot":13,"type":"weapon"},{"name":"weapon_appistol","amount":1,"info":{"quality":74.20000000000391,"ammo":10,"serie":"49IkT9Ry406ddCG"},"slot":14,"type":"weapon"}]', '2024-02-02 03:01:32', NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '197265', '{"Wheelie":{"Stat":"MP0_WHEELIE_ABILITY","Current":0,"RemoveAmount":-0.2,"icon":"fas fa-wheelchair"},"Scraping":{"Stat":"SCRAP_ABILITY","Current":0,"RemoveAmount":0,"icon":"fas fa-screwdriver"},"Searching":{"Stat":"BINDIVE_ABILITY","Current":0,"RemoveAmount":0,"icon":"fas fa-trash"},"Lumberjack":{"Stat":"TREE_ABILITY","Current":0,"RemoveAmount":0,"icon":"fas fa-tree"},"Sprint Driving":{"Stat":"DRIVER_ABILITY","Current":0,"RemoveAmount":0,"icon":"fas fa-car-alt"},"Lung Capacity":{"Stat":"MP0_LUNG_CAPACITY","Current":0,"RemoveAmount":-0.1,"icon":"fas fa-heartbeat"},"Drug Manufacture":{"Stat":"DRUGMAKE_ABILITY","Current":0,"RemoveAmount":0,"icon":"fas fa-pills"},"Heist Reputation":{"Stat":"HEIST_ABILITY","Current":0,"RemoveAmount":0,"icon":"fa-solid fa-user-secret"},"Strength":{"Stat":"MP0_STRENGTH","Current":0,"RemoveAmount":-0.3,"icon":"fas fa-dumbbell"},"Hitman":{"Stat":"HITMAN_ABILITY","Current":0,"RemoveAmount":0,"icon":"fas fa-skull"},"Driving":{"Stat":"MP0_DRIVING_ABILITY","Current":0,"RemoveAmount":-0.5,"icon":"fas fa-car-side"},"Delivery Runner":{"Stat":"RUNNER_ABILITY","Current":0,"RemoveAmount":0,"icon":"fas fa-car"},"Street Reputation":{"Stat":"DRUGREP_ABILITY","Current":0,"RemoveAmount":0,"icon":"fas fa-cannabis"},"Shooting":{"Stat":"MP0_SHOOTING_ABILITY","Current":0,"RemoveAmount":-0.1,"icon":"fas fa-bullseye"},"Stamina":{"Stat":"MP0_STAMINA","Current":0.1,"RemoveAmount":-0.3,"icon":"fas fa-walking"},"Electrical":{"Stat":"ELECTRICAL_ABILITY","Current":0,"RemoveAmount":0,"icon":"fas fa-bolt"},"Diving":{"Stat":"DIVING_ABILITY","Current":0,"RemoveAmount":0,"icon":"fas fa-water"},"Hacking":{"Stat":"HACK_ABILITY","Current":0,"RemoveAmount":0,"icon":"fas fa-laptop-code"}}'),
...
-- elused.playerskins: ~25 rows (yaklaşık) tablosu için veriler indiriliyor
...
INSERT INTO `playerskins` (`id`, `citizenid`, `model`, `skin`, `active`) VALUES
	...
	(35, 'BMS02698', 'mp_m_freemode_01', '{"model":"mp_m_freemode_01","tattoos":[],"headBlend":{"shapeFirst":0,"thirdMix":0,"skinThird":0,"skinMix":0,"shapeThird":0,"shapeMix":0,"skinSecond":0,"shapeSecond":0,"skinFirst":0},"components":[{"texture":0,"component_id":0,"drawable":0},{"texture":0,"component_id":1,"drawable":0},{"texture":0,"component_id":2,"drawable":0},{"texture":0,"component_id":3,"drawable":0},{"texture":0,"component_id":4,"drawable":0},{"texture":0,"component_id":5,"drawable":0},{"texture":0,"component_id":6,"drawable":0},{"texture":0,"component_id":7,"drawable":0},{"texture":0,"component_id":8,"drawable":0},{"texture":0,"component_id":9,"drawable":0},{"texture":0,"component_id":10,"drawable":0},{"texture":0,"component_id":11,"drawable":0}],"faceFeatures":{"cheeksWidth":0,"chinBoneLenght":0,"jawBoneWidth":0,"lipsThickness":0,"eyesOpening":0,"chinBoneLowering":0,"cheeksBoneWidth":0,"chinBoneSize":0,"eyeBrownHigh":0,"cheeksBoneHigh":0,"noseBoneTwist":0,"noseBoneHigh":0,"jawBoneBackSize":0,"nosePeakSize":0,"nosePeakHigh":0,"eyeBrownForward":0,"neckThickness":0,"nosePeakLowering":0,"noseWidth":0,"chinHole":0},"props":[{"prop_id":0,"texture":-1,"drawable":-1},{"prop_id":1,"texture":-1,"drawable":-1},{"prop_id":2,"texture":-1,"drawable":-1},{"prop_id":6,"texture":-1,"drawable":-1},{"prop_id":7,"texture":-1,"drawable":-1}],"headOverlays":{"beard":{"opacity":0,"style":0,"color":0},"eyebrows":{"opacity":0,"style":0,"color":0},"ageing":{"opacity":0,"style":0,"color":0},"chestHair":{"opacity":0,"style":0,"color":0},"sunDamage":{"opacity":0,"style":0,"color":0},"makeUp":{"opacity":0,"secondColor":0,"color":0,"style":0},"complexion":{"opacity":0,"style":0,"color":0},"blemishes":{"opacity":0,"style":0,"color":0},"bodyBlemishes":{"opacity":0,"style":0,"color":0},"lipstick":{"opacity":0,"style":0,"color":0},"blush":{"opacity":0,"style":0,"color":0},"moleAndFreckles":{"opacity":0,"style":0,"color":0}},"hair":{"color":0,"texture":0,"highlight":0,"style":0},"eyeColor":0}', 1),
	...
	(41, 'HTB94113', 'mp_m_freemode_01', '{"tattoos":[],"model":"mp_m_freemode_01","eyeColor":-1,"components":[{"component_id":0,"drawable":0,"texture":0},{"component_id":2,"drawable":0,"texture":0},{"component_id":3,"drawable":0,"texture":0},{"component_id":5,"drawable":0,"texture":0},{"component_id":6,"drawable":0,"texture":0},{"component_id":8,"drawable":0,"texture":0},{"component_id":10,"drawable":0,"texture":0},{"component_id":1,"drawable":35,"texture":0},{"component_id":4,"drawable":5,"texture":0},{"component_id":9,"drawable":18,"texture":9},{"component_id":7,"drawable":0,"texture":0},{"component_id":11,"drawable":6,"texture":0}],"headOverlays":{"ageing":{"opacity":0,"color":0,"style":0},"eyebrows":{"opacity":0,"color":0,"style":0},"makeUp":{"opacity":0,"color":0,"style":0,"secondColor":0},"blush":{"opacity":0,"color":0,"style":0},"chestHair":{"opacity":0,"color":0,"style":0},"moleAndFreckles":{"opacity":0,"color":0,"style":0},"sunDamage":{"opacity":0,"color":0,"style":0},"complexion":{"opacity":0,"color":0,"style":0},"bodyBlemishes":{"opacity":0,"color":0,"style":0},"beard":{"opacity":0,"color":0,"style":0},"blemishes":{"opacity":0,"color":0,"style":0},"lipstick":{"opacity":0,"color":0,"style":0}},"headBlend":{"skinMix":0,"shapeMix":0,"skinSecond":0,"shapeThird":0,"thirdMix":0,"shapeFirst":0,"shapeSecond":0,"skinThird":0,"skinFirst":0},"hair":{"highlight":0,"color":0,"texture":0,"style":0},"faceFeatures":{"chinBoneLowering":0,"eyeBrownHigh":0,"chinHole":0,"noseWidth":0,"cheeksWidth":0,"chinBoneLenght":0,"nosePeakSize":0,"nosePeakLowering":0,"noseBoneHigh":0,"noseBoneTwist":0,"jawBoneBackSize":0,"jawBoneWidth":0,"nosePeakHigh":0,"cheeksBoneHigh":0,"cheeksBoneWidth":0,"lipsThickness":0,"eyeBrownForward":0,"chinBoneSize":0,"eyesOpening":0,"neckThickness":0},"props":[{"drawable":-1,"texture":-1,"prop_id":0},{"drawable":-1,"texture":-1,"prop_id":1},{"drawable":-1,"texture":-1,"prop_id":2},{"drawable":-1,"texture":-1,"prop_id":6},{"drawable":-1,"texture":-1,"prop_id":7}]}', 1),
	...
	(47, 'DXH34648', 'mp_m_freemode_01', '{"headBlend":{"shapeMix":0,"shapeThird":0,"skinMix":0,"skinThird":0,"shapeSecond":0,"shapeFirst":0,"skinSecond":0,"thirdMix":0,"skinFirst":0},"props":[{"drawable":-1,"texture":-1,"prop_id":0},{"drawable":-1,"texture":-1,"prop_id":1},{"drawable":-1,"texture":-1,"prop_id":2},{"drawable":-1,"texture":-1,"prop_id":6},{"drawable":-1,"texture":-1,"prop_id":7}],"hair":{"style":16,"color":61,"texture":0,"highlight":61},"eyeColor":-1,"headOverlays":{"blemishes":{"opacity":0,"style":0,"color":0},"lipstick":{"opacity":0,"style":0,"color":0},"bodyBlemishes":{"opacity":0,"style":0,"color":0},"ageing":{"opacity":0,"style":0,"color":0},"moleAndFreckles":{"opacity":0,"style":0,"color":0},"eyebrows":{"opacity":0,"style":0,"color":0},"makeUp":{"opacity":0,"secondColor":0,"style":0,"color":0},"complexion":{"opacity":0,"style":0,"color":0},"chestHair":{"opacity":0,"style":0,"color":0},"blush":{"opacity":0,"style":0,"color":0},"beard":{"opacity":1,"style":16,"color":61},"sunDamage":{"opacity":0,"style":0,"color":0}},"faceFeatures":{"cheeksWidth":0,"nosePeakHigh":0,"eyesOpening":0,"jawBoneWidth":0,"cheeksBoneHigh":0,"noseBoneTwist":0,"neckThickness":0,"nosePeakSize":0,"lipsThickness":0,"chinBoneLenght":0,"eyeBrownForward":0,"eyeBrownHigh":0,"noseBoneHigh":0,"jawBoneBackSize":0,"cheeksBoneWidth":0,"nosePeakLowering":0,"chinBoneLowering":0,"noseWidth":0,"chinHole":0,"chinBoneSize":0},"model":"mp_m_freemode_01","tattoos":{"ZONE_HAIR":[{"collection":"multiplayer_overlays","hashFemale":"FM_F_Hair_003_a","name":"hair-0-186","zone":"ZONE_HAIR","hashMale":"FM_M_Hair_003_a","label":"hair-0-186"}]},"components":[{"drawable":0,"texture":0,"component_id":0},{"drawable":0,"texture":0,"component_id":1},{"drawable":16,"texture":0,"component_id":2},{"drawable":2,"texture":0,"component_id":3},{"drawable":48,"texture":1,"component_id":4},{"drawable":0,"texture":0,"component_id":5},{"drawable":8,"texture":0,"component_id":6},{"drawable":0,"texture":0,"component_id":7},{"drawable":28,"texture":0,"component_id":8},{"drawable":0,"texture":0,"component_id":9},{"drawable":0,"texture":0,"component_id":10},{"drawable":60,"texture":0,"component_id":11}]}', 1),
	...
	(58, 'HGO75866', 'mp_m_freemode_01', '{"tattoos":{"ZONE_HAIR":[{"collection":"multiplayer_overlays","hashMale":"FM_M_Hair_003_a","hashFemale":"FM_F_Hair_003_a","label":"hair-0-186","name":"hair-0-186","zone":"ZONE_HAIR"}]},"eyeColor":-1,"model":"mp_m_freemode_01","hair":{"highlight":0,"color":2,"style":12,"texture":0},"props":[{"prop_id":0,"texture":-1,"drawable":-1},{"prop_id":1,"texture":0,"drawable":2},{"prop_id":2,"texture":0,"drawable":2},{"prop_id":6,"texture":0,"drawable":10},{"prop_id":7,"texture":-1,"drawable":-1}],"faceFeatures":{"eyeBrownForward":0,"chinBoneSize":0,"chinHole":0,"neckThickness":0,"cheeksBoneHigh":0,"noseWidth":0,"cheeksBoneWidth":0,"eyesOpening":0,"jawBoneWidth":0,"nosePeakLowering":0,"chinBoneLowering":0,"lipsThickness":0,"eyeBrownHigh":0,"nosePeakSize":0,"cheeksWidth":0,"noseBoneTwist":0,"chinBoneLenght":0,"noseBoneHigh":0,"nosePeakHigh":0,"jawBoneBackSize":0},"components":[{"drawable":0,"component_id":0,"texture":0},{"drawable":0,"component_id":1,"texture":0},{"drawable":0,"component_id":2,"texture":0},{"drawable":0,"component_id":3,"texture":0},{"drawable":96,"component_id":4,"texture":0},{"drawable":0,"component_id":5,"texture":0},{"drawable":104,"component_id":6,"texture":0},{"drawable":0,"component_id":7,"texture":0},{"drawable":15,"component_id":8,"texture":0},{"drawable":0,"component_id":9,"texture":0},{"drawable":0,"component_id":10,"texture":0},{"drawable":55,"component_id":11,"texture":0}],"headOverlays":{"blush":{"color":0,"style":0,"opacity":0},"makeUp":{"color":0,"secondColor":0,"style":0,"opacity":0},"eyebrows":{"color":0,"style":0,"opacity":0.6},"chestHair":{"color":0,"style":0,"opacity":0},"sunDamage":{"color":0,"style":0,"opacity":0},"lipstick":{"color":0,"style":0,"opacity":0},"blemishes":{"color":0,"style":0,"opacity":0},"bodyBlemishes":{"color":0,"style":0,"opacity":0},"ageing":{"color":0,"style":0,"opacity":0},"complexion":{"color":0,"style":0,"opacity":0},"moleAndFreckles":{"color":0,"style":0,"opacity":0},"beard":{"color":0,"style":0,"opacity":0}},"headBlend":{"skinFirst":0,"thirdMix":0,"shapeFirst":0,"skinMix":0,"shapeMix":0,"shapeThird":0,"skinThird":0,"skinSecond":0,"shapeSecond":0}}', 1),
	...
	(61, 'CDR37384', 'mp_m_freemode_01', '{"props":[{"prop_id":0,"drawable":-1,"texture":-1},{"prop_id":1,"drawable":-1,"texture":-1},{"prop_id":2,"drawable":-1,"texture":-1},{"prop_id":6,"drawable":-1,"texture":-1},{"prop_id":7,"drawable":-1,"texture":-1}],"hair":{"style":77,"texture":0,"color":61,"highlight":61},"eyeColor":-1,"tattoos":{"ZONE_HAIR":[{"collection":"multiplayer_overlays","name":"hair-0-188","label":"hair-0-188","hashMale":"FM_M_Hair_003_c","zone":"ZONE_HAIR","hashFemale":"FM_F_Hair_003_c"}]},"model":"mp_m_freemode_01","faceFeatures":{"neckThickness":0,"cheeksBoneHigh":0,"chinBoneLowering":0.7,"chinHole":0,"eyesOpening":0,"jawBoneWidth":-0.3,"eyeBrownHigh":-0.3,"noseBoneHigh":0.5,"jawBoneBackSize":-0.4,"chinBoneSize":-0.5,"cheeksBoneWidth":0,"chinBoneLenght":-0.9,"noseBoneTwist":0,"cheeksWidth":0,"noseWidth":0,"nosePeakSize":0.5,"nosePeakLowering":-0.3,"eyeBrownForward":-0.6,"nosePeakHigh":0,"lipsThickness":0.8},"components":[{"texture":0,"drawable":0,"component_id":0},{"texture":0,"drawable":0,"component_id":1},{"texture":0,"drawable":77,"component_id":2},{"texture":0,"drawable":1,"component_id":3},{"texture":0,"drawable":24,"component_id":4},{"texture":0,"drawable":0,"component_id":5},{"texture":0,"drawable":0,"component_id":7},{"texture":0,"drawable":4,"component_id":8},{"texture":0,"drawable":0,"component_id":9},{"texture":0,"drawable":0,"component_id":10},{"texture":0,"drawable":10,"component_id":11},{"texture":0,"drawable":10,"component_id":6}],"headBlend":{"thirdMix":0,"shapeThird":0,"shapeSecond":0,"skinThird":0,"shapeMix":0.7,"skinFirst":0,"shapeFirst":4,"skinMix":0,"skinSecond":0},"headOverlays":{"blush":{"style":0,"color":0,"opacity":0},"beard":{"style":3,"color":0,"opacity":1},"ageing":{"style":0,"color":0,"opacity":0},"moleAndFreckles":{"style":0,"color":0,"opacity":0},"blemishes":{"style":0,"color":0,"opacity":0},"bodyBlemishes":{"style":0,"color":0,"opacity":0},"lipstick":{"style":0,"color":0,"opacity":0},"chestHair":{"style":0,"color":0,"opacity":0},"eyebrows":{"style":29,"color":61,"opacity":1},"makeUp":{"secondColor":0,"style":0,"color":0,"opacity":0},"sunDamage":{"style":0,"color":0,"opacity":0},"complexion":{"style":0,"color":0,"opacity":0}}}', 1),
	(64, 'WZB65598', 'mp_m_freemode_01', '{"props":[{"prop_id":2,"drawable":-1,"texture":-1},{"prop_id":6,"drawable":-1,"texture":-1},{"prop_id":7,"drawable":-1,"texture":-1},{"prop_id":0,"drawable":88,"texture":0},{"prop_id":1,"drawable":25,"texture":4}],"hair":{"style":25,"color":0,"texture":0,"highlight":0},"eyeColor":-1,"tattoos":{"ZONE_RIGHT_LEG":[{"collection":"mpbiker_overlays","name":"TAT_BI_040","label":"American Made","hashMale":"MP_MP_Biker_Tat_040_M","hashFemale":"MP_MP_Biker_Tat_040_F","zone":"ZONE_RIGHT_LEG"}],"ZONE_RIGHT_ARM":[{"collection":"mpbiker_overlays","name":"TAT_BI_033","label":"Eagle Emblem","hashMale":"MP_MP_Biker_Tat_033_M","hashFemale":"MP_MP_Biker_Tat_033_F","zone":"ZONE_RIGHT_ARM"}],"ZONE_TORSO":[{"collection":"mpbeach_overlays","name":"TAT_BB_018","label":"Ship Arms","hashMale":"MP_Bea_M_Back_000","hashFemale":"","zone":"ZONE_TORSO"}],"ZONE_LEFT_ARM":[{"collection":"mpbiker_overlays","name":"TAT_BI_016","label":"Macabre Tree","hashMale":"MP_MP_Biker_Tat_016_M","hashFemale":"MP_MP_Biker_Tat_016_F","zone":"ZONE_LEFT_ARM"}],"ZONE_HEAD":[{"collection":"mpbeach_overlays","name":"TAT_BB_028","label":"Little Fish","hashMale":"MP_Bea_M_Neck_000","hashFemale":"","zone":"ZONE_HEAD"},{"collection":"mpbeach_overlays","name":"TAT_BB_029","label":"Surfs Up","hashMale":"MP_Bea_M_Neck_001","hashFemale":"","zone":"ZONE_HEAD"},{"collection":"mpbusiness_overlays","name":"TAT_BUS_007","label":"Script Dollar Sign","hashMale":"MP_Buis_M_Neck_002","hashFemale":"","zone":"ZONE_HEAD"}],"ZONE_LEFT_LEG":[{"collection":"mpbiker_overlays","name":"TAT_BI_036","label":"Engulfed Skull","hashMale":"MP_MP_Biker_Tat_036_M","hashFemale":"MP_MP_Biker_Tat_036_F","zone":"ZONE_LEFT_LEG"}]},"model":"mp_m_freemode_01","faceFeatures":{"neckThickness":0,"cheeksBoneHigh":0,"chinBoneLowering":0,"cheeksWidth":0,"eyesOpening":0,"jawBoneWidth":0,"noseBoneTwist":0,"noseBoneHigh":0,"jawBoneBackSize":0,"chinBoneSize":0,"nosePeakHigh":-1,"chinBoneLenght":0,"chinHole":0,"eyeBrownForward":0,"lipsThickness":0,"cheeksBoneWidth":0,"nosePeakLowering":0,"eyeBrownHigh":0,"nosePeakSize":1,"noseWidth":1},"components":[{"texture":0,"drawable":0,"component_id":0},{"texture":0,"drawable":0,"component_id":1},{"texture":0,"drawable":0,"component_id":2},{"texture":0,"drawable":0,"component_id":5},{"texture":0,"drawable":0,"component_id":10},{"texture":0,"drawable":0,"component_id":7},{"texture":0,"drawable":76,"component_id":11},{"texture":0,"drawable":35,"component_id":8},{"texture":0,"drawable":0,"component_id":9},{"texture":1,"drawable":22,"component_id":3},{"texture":0,"drawable":24,"component_id":4},{"texture":1,"drawable":18,"component_id":6}],"headBlend":{"thirdMix":0,"shapeThird":0,"skinMix":1,"skinThird":0,"shapeMix":0,"skinSecond":3,"shapeFirst":0,"skinFirst":1,"shapeSecond":0},"headOverlays":{"blush":{"style":0,"color":0,"opacity":0},"beard":{"style":27,"color":0,"opacity":1},"ageing":{"style":0,"color":0,"opacity":0},"moleAndFreckles":{"style":0,"color":0,"opacity":0},"lipstick":{"style":0,"color":0,"opacity":0},"bodyBlemishes":{"style":0,"color":0,"opacity":0},"complexion":{"style":2,"color":0,"opacity":1},"chestHair":{"style":2,"color":35,"opacity":1},"eyebrows":{"style":12,"color":0,"opacity":1},"makeUp":{"secondColor":0,"style":0,"color":0,"opacity":0},"blemishes":{"style":0,"color":0,"opacity":0},"sunDamage":{"style":0,"color":0,"opacity":0}}}', 1),
	...
	(70, 'PAE72962', 'mp_m_freemode_01', '{"eyeColor":-1,"components":[{"component_id":0,"texture":0,"drawable":0},{"component_id":2,"texture":0,"drawable":3},{"component_id":10,"texture":0,"drawable":0},{"component_id":1,"texture":0,"drawable":0},{"component_id":7,"texture":0,"drawable":0},{"component_id":9,"texture":0,"drawable":0},{"component_id":5,"texture":0,"drawable":0},{"component_id":6,"texture":0,"drawable":0},{"component_id":8,"texture":0,"drawable":58},{"component_id":11,"texture":0,"drawable":15},{"component_id":4,"texture":0,"drawable":1},{"component_id":3,"texture":0,"drawable":4}],"faceFeatures":{"cheeksBoneHigh":0,"jawBoneBackSize":0,"eyesOpening":0,"nosePeakLowering":0,"nosePeakSize":0,"chinBoneLowering":0,"noseWidth":0,"cheeksBoneWidth":0,"chinBoneLenght":0,"eyeBrownHigh":0,"chinHole":0,"jawBoneWidth":0,"noseBoneTwist":0,"chinBoneSize":0,"neckThickness":0,"eyeBrownForward":0,"lipsThickness":0,"nosePeakHigh":0,"noseBoneHigh":0,"cheeksWidth":0},"hair":{"highlight":0,"color":0,"style":3,"texture":0},"model":"mp_m_freemode_01","headBlend":{"skinThird":0,"skinFirst":0,"skinSecond":0,"shapeMix":0,"shapeFirst":0,"thirdMix":0,"shapeSecond":0,"shapeThird":0,"skinMix":0},"props":[{"drawable":-1,"texture":-1,"prop_id":0},{"drawable":-1,"texture":-1,"prop_id":1},{"drawable":-1,"texture":-1,"prop_id":2},{"drawable":-1,"texture":-1,"prop_id":6},{"drawable":-1,"texture":-1,"prop_id":7}],"headOverlays":{"chestHair":{"secondColor":0,"color":0,"style":0,"opacity":0},"eyebrows":{"secondColor":0,"color":0,"style":0,"opacity":0},"blemishes":{"secondColor":0,"color":0,"style":0,"opacity":0},"moleAndFreckles":{"secondColor":0,"color":0,"style":0,"opacity":0},"lipstick":{"secondColor":0,"color":0,"style":0,"opacity":0},"bodyBlemishes":{"secondColor":0,"color":0,"style":0,"opacity":0},"makeUp":{"secondColor":0,"color":0,"style":0,"opacity":0},"beard":{"secondColor":0,"color":0,"style":0,"opacity":0},"complexion":{"secondColor":0,"color":0,"style":0,"opacity":0},"sunDamage":{"secondColor":0,"color":0,"style":0,"opacity":0},"ageing":{"secondColor":0,"color":0,"style":0,"opacity":0},"blush":{"secondColor":0,"color":0,"style":0,"opacity":0}},"tattoos":[]}', 1),
	(71, 'XRK76375', 'mp_m_freemode_01', '{"eyeColor":-1,"components":[{"component_id":0,"texture":0,"drawable":0},{"component_id":1,"texture":0,"drawable":0},{"component_id":2,"texture":0,"drawable":0},{"component_id":3,"texture":0,"drawable":0},{"component_id":5,"texture":0,"drawable":0},{"component_id":6,"texture":0,"drawable":8},{"component_id":7,"texture":0,"drawable":0},{"component_id":8,"texture":0,"drawable":15},{"component_id":9,"texture":0,"drawable":0},{"component_id":10,"texture":0,"drawable":0},{"component_id":4,"texture":3,"drawable":29},{"component_id":11,"texture":0,"drawable":656}],"faceFeatures":{"cheeksBoneHigh":0,"jawBoneBackSize":0,"noseBoneTwist":0,"nosePeakLowering":0,"nosePeakSize":0,"chinBoneLowering":0,"noseWidth":0,"cheeksBoneWidth":0,"chinBoneLenght":0,"jawBoneWidth":0,"eyeBrownHigh":0,"noseBoneHigh":0,"chinHole":0,"chinBoneSize":0,"neckThickness":0,"eyeBrownForward":0,"lipsThickness":0,"nosePeakHigh":0,"eyesOpening":0,"cheeksWidth":0},"hair":{"highlight":31,"color":44,"texture":0,"style":0},"model":"mp_m_freemode_01","headBlend":{"skinThird":0,"skinFirst":0,"skinSecond":0,"shapeMix":0,"shapeFirst":0,"skinMix":0,"shapeSecond":0,"shapeThird":0,"thirdMix":0},"props":[{"prop_id":0,"texture":-1,"drawable":-1},{"prop_id":1,"texture":-1,"drawable":-1},{"prop_id":2,"texture":-1,"drawable":-1},{"prop_id":6,"texture":-1,"drawable":-1},{"prop_id":7,"texture":-1,"drawable":-1}],"headOverlays":{"chestHair":{"secondColor":0,"color":0,"style":0,"opacity":0},"eyebrows":{"secondColor":0,"color":31,"style":29,"opacity":1},"blemishes":{"secondColor":0,"color":0,"style":0,"opacity":0},"moleAndFreckles":{"secondColor":0,"color":0,"style":0,"opacity":0},"sunDamage":{"secondColor":0,"color":0,"style":0,"opacity":0},"bodyBlemishes":{"secondColor":0,"color":0,"style":0,"opacity":0},"makeUp":{"secondColor":0,"color":0,"style":0,"opacity":0},"beard":{"secondColor":0,"color":0,"style":0,"opacity":0},"complexion":{"secondColor":0,"color":0,"style":0,"opacity":0},"lipstick":{"secondColor":0,"color":0,"style":0,"opacity":0},"ageing":{"secondColor":0,"color":0,"style":0,"opacity":0},"blush":{"secondColor":0,"color":0,"style":0,"opacity":0}},"tattoos":[]}', 1),
...
-- elused.player_mails: ~15 rows (yaklaşık) tablosu için veriler indiriliyor
...
INSERT INTO `player_mails` (`id`, `citizenid`, `sender`, `subject`, `message`, `read`, `mailid`, `date`, `button`) VALUES
	...
	(19, 'HTB94113', 'Hastane', 'Hastane Maliyetleri', 'Sayın Mr. Morgan, <br /><br />Son hastane ziyaretinin masraflarını içeren bir e-posta aldınız.<br />Nihai maliyetler ortaya çıktı: <strong>$2000</strong><br /><br />Gecmiş Olsun!', 0, 756519, '2024-01-27 13:44:32', '[]'),
...
-- elused.player_outfit_codes: ~1 rows (yaklaşık) tablosu için veriler indiriliyor
...
INSERT INTO `player_vehicles` (`id`, `license`, `citizenid`, `vehicle`, `hash`, `mods`, `plate`, `fakeplate`, `garage`, `fuel`, `engine`, `body`, `state`, `depotprice`, `drivingdistance`, `status`, `balance`, `paymentamount`, `datetimein`) VALUES
	...
	(33, 'license:987ed547c73270ca6274c4ee61400b5dbcc85e4c', 'DXH34648', 'tropos', '1887331236', 'null', 'QHDYETND', '', '', 100, 1000, 1000, 1, 0, 0, '', NULL, NULL, NULL),
	(34, 'license:987ed547c73270ca6274c4ee61400b5dbcc85e4c', 'DXH34648', 'tropos', '1887331236', 'null', 'BKQUSIAA', '', '', 100, 1000, 1000, 1, 0, 8, '', NULL, NULL, NULL),
	(35, 'license:987ed547c73270ca6274c4ee61400b5dbcc85e4c', 'DXH34648', 't20', '1663218586', 'null', 'FMZZDWBB', '', '', 100, 1000, 1000, 1, 0, 352, '', NULL, NULL, NULL),
	(36, 'license:987ed547c73270ca6274c4ee61400b5dbcc85e4c', 'DXH34648', 'visione', '-998177792', '{"tyreSmokeColor":[255,255,255],"modSmokeEnabled":false,"modOrnaments":-1,"modWindows":-1,"modSteeringWheel":-1,"plate":"FBWWAAOE","tireHealth":{"1":1000.0,"2":1000.0,"3":1000.0,"0":1000.0},"modAPlate":-1,"modTrimA":-1,"modKit21":-1,"modShifterLeavers":-1,"modFrontWheels":-1,"modTrimB":-1,"modCustomTiresF":false,"color1":34,"color2":1,"modFrame":-1,"modRoof":-1,"modLivery":-1,"dashboardColor":0,"modRightFender":-1,"modDial":-1,"modSeats":-1,"modTurbo":false,"modSpoilers":3,"modHorns":-1,"neonColor":[255,0,255],"xenonColor":255,"wheelColor":1,"modBrakes":-1,"modArchCover":-1,"modExhaust":-1,"modTank":-1,"modTrunk":-1,"bodyHealth":1000.0592475178704,"modKit17":-1,"tireBurstCompletely":{"1":false,"2":false,"3":false,"4":false,"5":false,"0":false},"modSuspension":-1,"neonEnabled":[false,false,false,false],"extras":[],"interiorColor":1,"modXenon":false,"modTransmission":-1,"modKit19":-1,"tankHealth":4000.2369900714818,"modGrille":-1,"wheelWidth":1.0,"modKit47":-1,"windowTint":-1,"modDashboard":-1,"pearlescentColor":158,"modEngineBlock":-1,"modAerials":-1,"wheelSize":1.0,"modEngine":-1,"plateIndex":0,"modBackWheels":-1,"engineHealth":1000.0592475178704,"doorStatus":{"1":false,"2":false,"3":false,"4":false,"5":false,"0":false},"modArmor":-1,"modCustomTiresR":false,"dirtLevel":0.0,"modPlateHolder":-1,"modFrontBumper":-1,"modDoorSpeaker":-1,"modVanityPlate":-1,"wheels":7,"modHydrolic":-1,"modFender":-1,"oilLevel":4.76596940834568,"model":-998177792,"windowStatus":{"1":true,"2":true,"3":true,"4":false,"5":false,"6":true,"7":true,"0":true},"modSideSkirt":-1,"tireBurstState":{"1":false,"2":false,"3":false,"4":false,"5":false,"0":false},"modHood":-1,"modSpeakers":-1,"modKit49":-1,"fuelLevel":65.13491524739108,"modAirFilter":-1,"headlightColor":255,"modStruts":-1,"liveryRoof":-1,"modRearBumper":3}', 'FBWWAAOE', '', '', 100, 1000, 1000, 1, 0, 1168, '', NULL, NULL, NULL),
	(37, 'license:987ed547c73270ca6274c4ee61400b5dbcc85e4c', 'DXH34648', 'tezeract', '1031562256', 'null', 'FGLURWJM', '', '', 100, 1000, 1000, 1, 0, 14094, '', NULL, NULL, NULL),
	(38, 'license:21f668b3835e9bcd1f243a28d0ee5358330f41f6', 'HGO75866', 'npolvette', '-1109563416', '{"neonEnabled":[false,false,false,false],"modKit49":-1,"modFender":-1,"pearlescentColor":66,"modAirFilter":-1,"tireHealth":{"1":1000.0,"2":1000.0,"3":1000.0,"0":1000.0},"modTurbo":false,"modKit47":-1,"modStruts":-1,"plate":"62MXK248","modSmokeEnabled":false,"modHydrolic":-1,"dashboardColor":63,"modSpoilers":-1,"dirtLevel":0.0,"plateIndex":4,"neonColor":[255,0,255],"modTrunk":-1,"modCustomTiresR":false,"modRearBumper":-1,"modAPlate":-1,"modSuspension":-1,"headlightColor":255,"modTrimA":-1,"modRightFender":-1,"wheelSize":0.0,"modXenon":false,"bodyHealth":1000.0592475178704,"modBackWheels":-1,"modLivery":-1,"modDial":-1,"engineHealth":1000.0592475178704,"modExhaust":-1,"modSideSkirt":-1,"extras":{"4":false,"3":false,"2":true,"1":false,"6":false,"5":false},"modWindows":-1,"modRoof":-1,"tireBurstState":{"1":false,"2":false,"3":false,"4":false,"5":false,"0":false},"modGrille":-1,"modKit17":-1,"modTank":-1,"windowTint":-1,"tankHealth":1000.0592475178704,"xenonColor":255,"color2":141,"tyreSmokeColor":[255,255,255],"modAerials":-1,"modEngine":-1,"modTrimB":-1,"interiorColor":111,"modFrame":-1,"modPlateHolder":-1,"modKit19":-1,"modEngineBlock":-1,"modSeats":-1,"modHorns":-1,"modOrnaments":-1,"modCustomTiresF":false,"modBrakes":-1,"modHood":-1,"modTransmission":-1,"windowStatus":{"1":true,"2":true,"3":true,"4":false,"5":false,"6":true,"7":true,"0":true},"wheelColor":0,"doorStatus":{"1":false,"2":false,"3":false,"4":false,"5":false,"0":false},"tireBurstCompletely":{"1":false,"2":false,"3":false,"4":false,"5":false,"0":false},"modFrontBumper":-1,"color1":141,"oilLevel":7.14895411251853,"fuelLevel":65.13491524739108,"modArchCover":-1,"modFrontWheels":-1,"wheelWidth":0.0,"modShifterLeavers":-1,"modSteeringWheel":-1,"modDoorSpeaker":-1,"modDashboard":-1,"modKit21":-1,"wheels":0,"modArmor":-1,"liveryRoof":-1,"model":-1109563416,"modVanityPlate":-1,"modSpeakers":-1}', '62MXK248', NULL, NULL, 100, 1000, 1000, 1, 0, 779852, NULL, NULL, NULL, NULL),
	(39, 'license:759f35b0a5e54b71040546417277a6471bac20df', 'CDR37384', 'tezeract', '1031562256', '{"tyreSmokeColor":[255,255,255],"neonColor":[255,0,255],"modCustomTiresR":false,"modKit49":-1,"modBrakes":-1,"wheelWidth":1.0,"tankHealth":997.6762628136975,"modAirFilter":-1,"oilLevel":4.76596940834568,"modKit19":-1,"headlightColor":255,"plateIndex":0,"color1":1,"interiorColor":0,"liveryRoof":-1,"dirtLevel":11.91492352086422,"modDial":-1,"modKit21":-1,"tireBurstState":{"1":false,"2":false,"3":false,"4":false,"5":false,"0":false},"dashboardColor":0,"modSuspension":-1,"xenonColor":255,"bodyHealth":996.8819345789732,"modSeats":-1,"modShifterLeavers":-1,"modWindows":-1,"modFender":-1,"modDoorSpeaker":-1,"modAPlate":-1,"modSteeringWheel":-1,"modTrimA":-1,"modSpoilers":-1,"tireBurstCompletely":{"1":false,"2":false,"3":false,"4":false,"5":false,"0":false},"modDashboard":-1,"modHydrolic":-1,"modRearBumper":-1,"modSideSkirt":-1,"extras":[],"modVanityPlate":-1,"modHorns":-1,"modGrille":-1,"modKit47":-1,"modEngine":-1,"modFrontBumper":-1,"modSmokeEnabled":false,"modXenon":false,"wheelSize":1.0,"modStruts":-1,"modRightFender":-1,"neonEnabled":[false,false,false,false],"model":1031562256,"modRoof":-1,"doorStatus":{"1":false,"2":false,"3":false,"4":false,"5":false,"0":false},"modFrame":-1,"modAerials":-1,"modTrunk":-1,"pearlescentColor":3,"modTank":-1,"modTransmission":-1,"tireHealth":{"1":1000.0,"2":1000.0,"3":1000.0,"0":1000.0},"modKit17":-1,"plate":"KKNDEDLN","wheels":7,"modCustomTiresF":false,"color2":38,"modBackWheels":-1,"modEngineBlock":-1,"modArmor":-1,"modHood":-1,"windowTint":-1,"wheelColor":0,"modPlateHolder":-1,"modTurbo":false,"modExhaust":-1,"modTrimB":-1,"engineHealth":1000.0592475178704,"modSpeakers":-1,"modArchCover":-1,"modOrnaments":-1,"modFrontWheels":-1,"windowStatus":{"1":true,"2":true,"3":true,"4":false,"5":false,"6":true,"7":true,"0":true},"fuelLevel":65.13491524739108,"modLivery":-1}', 'KKNDEDLN', '', '', 100, 1000, 1000, 1, 0, 23913, '', NULL, NULL, NULL),
	(40, 'license:21f668b3835e9bcd1f243a28d0ee5358330f41f6', 'HGO75866', 'npolvette', '-1109563416', '{"neonEnabled":[false,false,false,false],"modKit49":-1,"modFender":-1,"pearlescentColor":66,"modAirFilter":-1,"tireHealth":{"1":1000.0,"2":1000.0,"3":1000.0,"0":1000.0},"modTurbo":1,"modKit47":-1,"modStruts":-1,"plate":"83VMI443","modSmokeEnabled":false,"modHydrolic":-1,"dashboardColor":63,"modSpoilers":-1,"dirtLevel":0.0,"plateIndex":4,"neonColor":[255,0,255],"modTrunk":-1,"modCustomTiresR":false,"modRearBumper":-1,"modAPlate":-1,"modSuspension":3,"headlightColor":255,"modTrimA":-1,"modRightFender":-1,"wheelSize":0.0,"modXenon":false,"bodyHealth":1000.0592475178704,"modBackWheels":-1,"modLivery":-1,"modDial":-1,"engineHealth":1000.0592475178704,"modExhaust":-1,"modSideSkirt":-1,"extras":{"4":false,"3":false,"2":false,"1":false,"6":false,"5":false},"modWindows":-1,"modRoof":-1,"tireBurstState":{"1":false,"2":false,"3":false,"4":false,"5":false,"0":false},"modGrille":-1,"modKit17":-1,"modTank":-1,"windowTint":-1,"tankHealth":1000.0592475178704,"xenonColor":255,"color2":141,"tyreSmokeColor":[255,255,255],"modAerials":-1,"modEngine":4,"modTrimB":-1,"interiorColor":111,"modFrame":-1,"modPlateHolder":-1,"modKit19":-1,"modEngineBlock":-1,"modSeats":-1,"modHorns":-1,"modOrnaments":-1,"modCustomTiresF":false,"modBrakes":2,"modHood":-1,"modTransmission":3,"windowStatus":{"1":true,"2":true,"3":true,"4":false,"5":false,"6":true,"7":true,"0":true},"wheelColor":0,"doorStatus":{"1":false,"2":false,"3":false,"4":false,"5":false,"0":false},"tireBurstCompletely":{"1":false,"2":false,"3":false,"4":false,"5":false,"0":false},"modFrontBumper":-1,"color1":141,"oilLevel":7.14895411251853,"fuelLevel":65.13491524739108,"modArchCover":-1,"modFrontWheels":-1,"wheelWidth":0.0,"modShifterLeavers":-1,"modSteeringWheel":-1,"modDoorSpeaker":-1,"modDashboard":-1,"modKit21":-1,"wheels":0,"modArmor":4,"liveryRoof":-1,"model":-1109563416,"modVanityPlate":-1,"modSpeakers":-1}', '83VMI443', NULL, NULL, 100, 1000, 1000, 1, 0, 510562, NULL, NULL, NULL, NULL),
	...
	(44, 'license:759f35b0a5e54b71040546417277a6471bac20df', 'CDR37384', 'npolexp', '417470901', '{}', 'PD  5413', NULL, NULL, 100, 1000, 1000, 1, 0, 888, NULL, NULL, NULL, NULL),
	...
	(46, 'license:987ed547c73270ca6274c4ee61400b5dbcc85e4c', 'DXH34648', 'xa21', '917809321', 'null', 'MLEOCDNO', '', '', 100, 1000, 1000, 1, 0, 1783, '', NULL, NULL, NULL),
...
-- elused.stashitems: ~38 rows (yaklaşık) tablosu için veriler indiriliyor
...
-- elused.trunkitems: ~3 rows (yaklaşık) tablosu için veriler indiriliyor
