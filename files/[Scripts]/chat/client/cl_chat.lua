...
RegisterNetEvent('player:chatRead:client')
AddEventHandler('player:chatRead:client', function(serverId,durum)
    displaying = durum
    while displaying do
        Wait(0)
...
function DisplayTyping(ped, text)
