...
--             TriggerServerEvent('qb-adminmenu:log:minPage',"vehicle","savecar","blue")
--         else
...
RegisterNetEvent('qb-admin:client:SetSpeed', function()
    local ped = PlayerId()
    speed = not speed
    TriggerServerEvent('qb-adminmenu:log:minPage',"other","fast speed","blue")
    if speed then
...
RegisterNetEvent("qb-admin:client:reviveSelf", function()
    ...
    TriggerServerEvent('qb-adminmenu:log:minPage',"revive","revive","black")
end)
...
RegisterNetEvent("qb-admin:client:godMode", function()
    godmode = not godmode
    TriggerServerEvent('qb-adminmenu:log:minPage',"godmode","godmode","black")
    if godmode then
        while godmode do
            Wait(0)
...
RegisterNetEvent("qb-admin:client:infiniteAmmo", function()
    ...
    TriggerServerEvent('qb-adminmenu:log:minPage',"other","infinite ammo","blue")
    local ped = PlayerPedId()
...
RegisterNetEvent("qb-admin:client:invisible", function()
    ...
    TriggerServerEvent('qb-adminmenu:log:minPage',"invisible","invisible","black")
    if invisible then
...
RegisterNetEvent("qb-admin:client:vehicleGodMode", function()
    ...
    TriggerServerEvent('qb-adminmenu:log:minPage',"vehicle","veh godmode","blue")
    local ped = PlayerPedId()
    local vehicle = GetVehiclePedIsIn(ped, false)
...
RegisterNetEvent('qb-admin:client:maxmodVehicle', function()
    ...
    TriggerServerEvent('qb-adminmenu:log:minPage',"vehicle","maxmods","blue")
end)
