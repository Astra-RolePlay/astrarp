local Translations = {
    ...
    success = {
        ["blips_activated"] = "Blip'ler aktif edildi",
        ...
        ["noclip_enabled"] = "Noclip aktif edildi",
        ["noclip_disabled"] = "Noclip devre dışı bırakıldı",
    },
    info = {
    ...
    desc = {
        ...
        ["noclip_desc"] = "Noclip Etkinleştir/Devre Dışı Bırak",
    ...
    commands = {
        ...
        ["toogle_noclip"] = "Noclip aç/kapat [Yetkili İçin]",
