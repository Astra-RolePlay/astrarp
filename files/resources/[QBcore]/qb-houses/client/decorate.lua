...
RegisterNUICallback('selectOwnedObject', function(data, cb)
	...
	local ownedObject = GetClosestObjectOfType(objectData.x, objectData.y, objectData.z, 1.5,
		GetHashKey(objectData.hashname), false, 6, 7)
	...
	while true do
		...
		if DecoMode then
			...
			if SelectedObj and peanut then
				...
				DrawMarker(21, SelObjPos.x, SelObjPos.y, SelObjPos.z + 1.28, 0.0, 0.0, 0.0, 180.0, 0.0, 0.0, 0.6, 0.6,
					0.6, 28, 149, 255, 100, true, true, 2, false, false, false, false)
