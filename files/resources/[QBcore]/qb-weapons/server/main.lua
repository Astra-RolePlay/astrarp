...
QBCore.Functions.CreateCallback("weapons:server:RepairWeapon", function(source, cb, RepairPoint, data)
    ...
    local Player = QBCore.Functions.GetPlayer(src)
    local second = 1 * 1000
    local Timeout = math.random(5 * second, 10 * second)
...
QBCore.Commands.Add("silahtamir", "Repair Weapon (God Only)", {{name="hp", help=Lang:t('info.hp_of_weapon')}}, true, function(source, args)
