			...
			if currWeapon ~= GetSelectedPedWeapon(ped) then
				...
				if CheckWeapon(newWeap) then
					if holstered then
						...
						if PlayerData.job.name == 'police' or PlayerData.job.name == 'sheriff' or PlayerData.job.name == 'sasp' or PlayerData.job.name == 'sahp' or PlayerData.job.name == 'fbi' then
					...
					elseif newWeap ~= currWeapon and CheckWeapon(currWeapon) then
						...
						local PlayerData = QBCore.Functions.GetPlayerData()
						if PlayerData.job.name == 'police' or PlayerData.job.name == 'sheriff' or PlayerData.job.name == 'sasp' or PlayerData.job.name == 'sahp' or PlayerData.job.name == 'fbi' or PlayerData.job.name == 'doj' then
							SetCurrentPedWeapon(ped, `WEAPON_UNARMED`, true)
							currentHolster = GetPedDrawableVariation(ped, 7)
							currentHolsterTexture = GetPedTextureVariation(ped, 7)
							TaskPlayAnimAdvanced(ped, "rcmjosh4", "josh_leadout_cop2", pos.x, pos.y, pos.z, 0, 0, rot, 3.0, 3.0, -1, 50, 0, 0, 0)
