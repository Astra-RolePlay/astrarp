...
function setupLocations(locations, myHouses) {
    ...
    $(parent).append('<div class="loclabel" id="location" data-location="null" data-type="lab" data-label="Nereden başlamak istersin?"><p><span id="null">Nereden başlamak istersin?</span></p></div>')
...
function setupApps(app) {
    var parent = $('.spawn-locations')
    $(parent).html("");

    $(parent).append('<div class="loclabel" id="location" data-location="null" data-type="lab" data-label="Apartman seç"><p><span id="null">Apartman seç</span></p></div>')

    $(parent).append('<div class="location" id="location" data-location="'+app.name+'" data-type="appartment" data-label="'+app.label+'"><p><span id="'+app.name+'">Rastgele Motel Odası</span></p></div>')
