...
-- Depo Event
RegisterNetEvent('qb-fbijob:OpenStash', function(data)
...
RegisterNetEvent('qb-fbijob:Dna', function()
    local Menu = {
        {
            header = "DNA Deposu",
            isMenuHeader = true,
...
RegisterNetEvent('qb-fbijob:Kanit', function()
    local Menu = {
        {
            header = "Kanıt Deposu",
            isMenuHeader = true,
...
RegisterNetEvent('qb-fbijob:client:Charge', function()
    ...
    if dialog then
        ...
        TriggerServerEvent('qb-fbijob:server:Charge', dialog.citizen, dialog.price)
    end
end)