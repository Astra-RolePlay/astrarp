...
RegisterNetEvent('Fbi:client:policeAlert', function(coords, text)
...
RegisterNetEvent('Fbi:client:SendPoliceEmergencyAlert', function()
    local Player = QBCore.Functions.GetPlayerData()
    
    TriggerServerEvent('Fbi:server:policeAlert', Lang:t('info.officer_down', {lastname = Player.charinfo.lastname, callsign = Player.metadata.callsign}))
