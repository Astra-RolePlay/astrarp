...
Config.ReviveInterval = 10 -- How long the timer is for players to revive a player in laststand
Config.MinimumRevive = 0 -- How long the timer is for players to revive a player in laststand
Config.PainkillerInterval = 60 -- Set the length of time painkillers last (per one)
Config.HealthDamage = 99 -- Minumum damage done to health before checking for injuries
...
Config.BleedTickRate = 8000000 -- How much time, in seconds, between bleed ticks
...
Config.BleedMovementAdvance = 0 -- How much time moving while bleeding adds
Config.BleedTickDamage = 0 -- The base damage that is multiplied by bleed level everytime a bleed tick occurs
...
Config.HeadInjuryTimer = 30000000 -- How much time, in seconds, do head injury effects chance occur
Config.ArmInjuryTimer = 30000000 -- How much time, in seconds, do arm injury effects chance occur
Config.LegInjuryTimer = 30000000 -- How much time, in seconds, do leg injury effects chance occur
...
Config.Locations = { -- Edit the various interaction points for players or create new ones
    ["checking"] = {
	    [1] = vector3(310.46, -585.89, 43.27),
	    [2] = vector3(-252.01, 6335.6, 32.43), -- paleto
    },
    ["duty"] = {
        [1] = vector3(312.31, -582.69, 43.27),
        [2] = vector3(-254.66, 6324.71, 32.41),
    },
    ["vehicle"] = {
        [1] = vector4(1296.35, -604.28, 43.31, 68.5),
        [2] = vector4(1164.78, 6340.72, 32.43, 269.7),
    },
    ["helicopter"] = {
        [1] = vector4(351.98, -588.24, 74.17, 73.25),
        [2] = vector4(-252.19, 6319.36, 39.66, 136.05),
    },
    ["armory"] = {
        [1] = vector3(325.83, -590.83, 43.27),
        [2] = vector3(-252.48, 6313.23, 32.31),
    },
    ["roof"] = {
        [1] = vector4(338.5, -583.85, 74.16, 245.5),
    },
    ["main"] = {
        [1] = vector3(336.29, -589.02, 43.27),
    },
    ["stash"] = {
        [1] = vector3(314.63, -581.09, 43.27),
        [2] = vector3(-247.04, 6313.68, 32.43),

    },
    ["beds"] = {
        [1] = {coords = vector4(316.9, -584.56, 42.27,338.0), taken = false, model = -421052012},
        [2] = {coords = vector4(319.78, -585.6, 42.27, 338.08), taken = false, model = -421052012},
        [3] = {coords = vector4(322.64, -586.71, 42.27, 338.32), taken = false, model = -421052012},
        [4] = {coords = vector4(325.6, -587.79, 42.27, 338.32), taken = false, model = -421052012},
        [5] = {coords = vector4(328.44, -588.82, 42.27, 336.32), taken = false, model = -421052012},
        [6] = {coords = vector4(330.68, -584.9, 42.27, 160.08), taken = false, model = -421052012},
        [7] = {coords = vector4(327.57, -583.75, 42.27, 160.08), taken = false, model = -421052012},
        [8] = {coords = vector4(321.27, -581.55, 42.27, 160.08), taken = false, model = -421052012},
        [9] = {coords = vector4(318.39, -580.5, 42.27, 160.08), taken = false, model = -421052012},

	--- paleto
        [10] = {coords = vector4(-257.74, 6321.62, 33.35, 314.33), taken = false, model = 2117668672},
        [11] = {coords = vector4(-260.14, 6324.04, 33.35, 314.71), taken = false, model = 2117668672},
        [12] = {coords = vector4(-262.56, 6326.35, 33.35, 314.37), taken = false, model = 2117668672},
        [13] = {coords = vector4(-258.98, 6330.08, 33.35, 135.4), taken = false, model = 2117668672},
        [14] = {coords = vector4(-256.52, 6327.85, 33.40, 130.45), taken = false, model = 2117668672},
    },
    -- ["jailbeds"] = {
    ...
    ["stations2"] = {
        [1] = {label = "Paleto Bay Hastanesi", coords = vector4(-235.17, 6313.75, 31.47, 343.84)},
    }
}
...
Config.Peds = {   
	[1] = { handle = nil, model ="s_m_m_doctor_01", coords = vector3(310.46, -585.89, 43.27), heading = 102.43,  anim = { type = 1, name = "WORLD_HUMAN_CLIPBOARD"} }, -- scene
	[2] = { handle = nil, model ="s_m_m_doctor_01", coords = vector3(-252.01, 6335.6, 32.43), heading = 178.5,  anim = { type = 1, name = "WORLD_HUMAN_CLIPBOARD"} }, -- scene
}
