		...
		if isDead or InLaststand then
            ...
            if isDead then
                if not isInHospitalBed then
                    if deathTime > 0 then
                        DrawTxt(0.93, 1.44, 1.0,1.0,0.4, "~b~[F3] ~w~Bildirim Gönder | Yeniden Dogmana: ~r~" .. math.ceil(deathTime) .. "~w~ Saniye Kaldı", 255, 255, 255, 255)
                    else
                        DrawTxt(0.875, 1.46, 1.0, 1.0, 0.4, "~b~[F3] ~w~Bildirim Gönder | Yeniden dogmak için ~b~[E] ~w~tusuna basılı tut (~g~$"..Config.BillCost.."~w~)", 255, 255, 255, 255)
                    end
                end
            ...
            elseif InLaststand then
                ...
                if LaststandTime > Config.MinimumRevive then
                    DrawTxt(0.93, 1.44, 1.0,1.0,0.4, "~b~[F3] ~w~Bildirim Gönder | Yeniden Dogmana: ~r~" .. math.ceil(LaststandTime) .. "~w~ Saniye Kaldı", 255, 255, 255, 255)
                else
                    DrawTxt(0.875, 1.46, 1.0, 1.0, 0.4, "~b~[F3] ~w~Bildirim Gönder | Yeniden dogmak için ~b~[E] ~w~tusuna basılı tut (~g~$"..Config.BillCost.."~w~)", 255, 255, 255, 255)
