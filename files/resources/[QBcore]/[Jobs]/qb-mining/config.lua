...
Config = {
	...
	Locations =  {
		['MineStore'] = {
			{ name = "Maden Ocağı", coords = vector4(-594.96, 2091.3, 131.47, 67.65), sprite = 527, col = 81, blipTrue = true, model = `G_M_M_ChemWork_01`, scenario = "",  },		-- The location where you enter the mine
			{ name = "Kazı Alanı", coords = vector4(2960.9, 2754.14, 43.71, 204.58), sprite = 527, col = 81, blipTrue = true, model = `G_M_M_ChemWork_01`, scenario = "",  },
			{ name = "Maden Eritme", coords = vector4(1074.89, -1988.19, 30.89, 235.07), sprite = 436, col = 1, blipTrue = true, model = `G_M_M_ChemWork_01`, scenario = "",  },
		},
		['Smelter'] = {	 -- The location of the smelter
			{ name = "Madenci", coords = vector3(1112.29, -2009.9, 31.46), sprite = 436, col = 1, blipTrue = false, },
		},
		["Washing"] = {
			{ name = "Taş Yıkama", coords = vector3(1840.18, 412.42, 160.49), sprite = 618, col = 3, disp = 6, blipTrue = true }, -- Mountains
			{ name = "Taş Yıkama", coords = vector3(1870.91, 395.1, 160.16), sprite = 618, col = 3, disp = 6, blipTrue = false },

			{ name = "Taş Yıkama", coords = vector3(-432.59, 2936.84, 13.87), sprite = 618, col = 3, disp = 6, blipTrue = true }, -- Stream Blip
			{ name = "Taş Yıkama", coords = vector3(-422.37, 2946.18, 13.77), sprite = 618, col = 3, blipTrue = false },
			{ name = "Taş Yıkama", coords = vector3(-443.21, 2926.5, 13.62), sprite = 618, col = 3, blipTrue = false },
			{ name = "Taş Yıkama", coords = vector3(-455.48, 2917.16, 13.52), sprite = 618, col = 3, blipTrue = false },

			{ name = "Taş Yıkama", coords = vector3(2500.64, 6129.4, 162.46), sprite = 618, col = 3, disp = 6, blipTrue = true }, -- Gordo

			{ name = "Taş Yıkama", coords = vector3(907.06, 4377.66, 30.28), sprite = 618, col = 3, disp = 6, blipTrue = true }, -- Alamo Sea
			{ name = "Taş Yıkama", coords = vector3(894.14, 4386.56, 30.24), sprite = 618, col = 3, blipTrue = false },
			{ name = "Taş Yıkama", coords = vector3(893.12, 4370.74, 30.35), sprite = 618, col = 3, blipTrue = false },
			{ name = "Taş Yıkama", coords = vector3(912.88, 4365.7, 30.39), sprite = 618, col = 3, blipTrue = false },
		},
		["Panning"] = {
			{ name = "Altın Eleme", coords = vector3(-1656.67, 2074.85, 87.37), sprite = 618, col = 5, disp = 6, blipTrue = true }, -- Vineyard
			{ name = "Altın Eleme", coords = vector3(-1672.06, 2070.89, 91.68), sprite = 618, col = 5, blipTrue = false },

			{ name = "Altın Eleme", coords = vector3(-1273.16, 1898.19, 100.82), sprite = 618, col = 5, disp = 6, blipTrue = true }, -- Tongva

			{ name = "Altın Eleme", coords = vector3(-1551.31, 1444.15, 116.44), sprite = 618, col = 5, disp = 6, blipTrue = true }, -- Tongva
			{ name = "Altın Eleme", coords = vector3(-1565.47, 1431.46, 117.1), sprite = 618, col = 5, blipTrue = false },
			{ name = "Altın Eleme", coords = vector3(-1578.39, 1419.59, 118.13), sprite = 618, col = 5, blipTrue = false },

			{ name = "Altın Eleme", coords = vector3(-850.78, 4433.95, 14.21), sprite = 618, col = 5, disp = 6, blipTrue = true }, -- Wilderness
		},
		['Cracking'] = { -- The location of the smelter
			{ name = "Taş Kazma", coords = vector4(1109.19, -1992.8, 30.98, 146.88), sprite = 566, col = 81, blipTrue = false, prop = `prop_vertdrill_01` }, -- Foundary
			{ name = "Taş Kazma", coords = vector4(1105.56, -1992.53, 30.94, 238.19), sprite = 566, col = 81, blipTrue = false, prop = `prop_vertdrill_01` }, -- Foundary
		},
		['OreBuyer'] = { -- The Locations of the ore buyers
			{ name = "Cevher Satış", coords = vector4(1054.05, -1952.9, 32.09, 273.09), sprite = 568, col = 81, blipTrue = false, model = `G_M_M_ChemWork_01`, scenario = "", },
		},
		['JewelCut'] = { -- The Location of the jewel cutting bench. Couldn't decide so left in smeltery
			{ name = "Mücevher Kesme", coords = vector4(1077.11, -1984.22, 31.02, 235.8), sprite = 566, col = 81, blipTrue = false, prop = `gr_prop_gr_speeddrill_01c` },
			{ name = "Mücevher Kesme", coords = vector4(1075.19, -1985.45, 30.92, 144.89), sprite = 566, col = 81, blipTrue = false, prop = `gr_prop_gr_speeddrill_01c` },
		},
		['JewelBuyer'] = { -- The Location of the jewel buyer, I left this as Vangelico, others will proabably change to pawn shops
			{ name = "Müchever Satış", coords = vector4(-618.65, -228.25, 38.06, 122.54), sprite = 527, col = 617, blipTrue = false, model = `S_M_M_HighSec_03`, scenario = "", },
		},
	},
...
--Mining Store Items
	Items = {
		label = "Maden Malzemeleri",  slots = 6,
		items = {
			{ name = "weapon_flashlight", price = 5000, amount = 1, info = {}, type = "item", slot = 1, },
			{ name = "goldpan", price = 1500, amount = 1, info = {}, type = "item", slot = 2, },
			{ name = "pickaxe",	price = 2000, amount = 1, info = {}, type = "item", slot = 3, },
			{ name = "miningdrill",	price = 20000, amount = 1, info = {}, type = "item", slot = 4, },
			{ name = "mininglaser",	price = 40000, amount = 1, info = {}, type = "item", slot = 5, },
			{ name = "drillbit", price = 5, amount = 50, info = {}, type = "item", slot = 6, },
		},
	},
}
Crafting = {
