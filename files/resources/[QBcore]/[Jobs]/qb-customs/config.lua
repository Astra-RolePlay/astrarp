...
bennyGarages = {
    ...
    [35] = {coords = vector4(544.23, -189.63, 54.49,  267.52),  useJob = true,  job = {"mechanic1"}},    -- Mekanik 1
    [36] = {coords = vector4(543.85, -179.15, 54.49,  264.38),  useJob = true,  job = {"mechanic1"}},    -- Mekanik 1
    [37] = { coords = vector4(537.15, -171.09, 54.49, 357.25), useJob = true, job = { "mechanic1" } },   -- Mekanik 1
    
    [65] = {coords = vector4(136.05,  -3030.59,  7.04,  181.55),  useJob = true,  job = {"mechanic2"}},  -- Mekanik 2
    [66] = {coords = vector4(144.71,  -3030.38,  7.04,  175.77),  useJob = true,  job = {"mechanic2"}},  -- Mekanik 2
    [67] = {coords = vector4(124.91, -3041.57, 6.62, 92.29),  useJob = true,  job = {"mechanic2"}},      -- Mekanik 2
    [69] = {coords = vector4(125.42, -3047.12, 6.62, 89.86),  useJob = true,  job = {"mechanic3"}},      -- Mekanik 2

    [69] = {coords = vector4(1182.52, 2638.52, 37.37, 176.99),  useJob = true,  job = {"mechanic3"}},    -- Mekanik 3



    [9] = {coords = vector4(-210.31, -1324.47, 30.89,  358.61),  useJob = true,  job = {"mechanic4"}},   -- Mekanik 4 
    [10] = {coords = vector4(-222.52, -1330.1, 30.89,  269.69),  useJob = true,  job = {"mechanic4"}},   -- Mekanik 4

    [38] = {coords = vector4(-327.01, -144.38, 39.02,  246.59),  useJob = true,  job = {"mechanic4"}},   -- Mekanik 5
    [39] = {coords = vector4(-325.01, -139.29, 39.02,  246.59),  useJob = true,  job = {"mechanic5"}},   -- Mekanik 5
    [40] = {coords = vector4(-323.3, -134.1, 39.02,  246.59),    useJob = true,  job = {"mechanic5"}},   -- Mekanik 5
    [41] = {coords = vector4(-321.54, -128.79, 39.02,  246.59),  useJob = true,  job = {"mechanic5"}},   -- Mekanik 5
    [42] = {coords = vector4(-319.55, -123.55, 39.02,  246.59),  useJob = true,  job = {"mechanic5"}},   -- Mekanik 5
    [43] = {coords = vector4(-317.78, -118.37, 39.02,  246.59),  useJob = true,  job = {"mechanic5"}},   -- Mekanik 5
    [44] = {coords = vector4(-315.67, -113.29, 39.02,  246.59),  useJob = true,  job = {"mechanic5"}},   -- Mekanik 5
    [45] = {coords = vector4(-313.78, -108.15, 39.02,  246.59),  useJob = true,  job = {"mechanic5"}},   -- Mekanik 5
    [46] = {coords = vector4(-311.84, -102.78, 39.02,  246.59),  useJob = true,  job = {"mechanic5"}},   -- Mekanik 5
    [47] = {coords = vector4(-338.9, -95.08, 39.02,  246.59),   useJob = true,  job = {"mechanic5"}},    -- Mekanik 5
    [48] = {coords = vector4(-353.56, -90.07, 39.02,  246.59),  useJob = true,  job = {"mechanic5"}},    -- Mekanik 5
    [49] = {coords = vector4(-366.39, -85.15, 39.02,  246.59),  useJob = true,  job = {"mechanic5"}},    -- Mekanik 5
    [50] = {coords = vector4(-342.52, -114.01, 39.01,  72.12),  useJob = true,  job = {"mechanic5"}},    -- Mekanik 5
    [51] = {coords = vector4(-346.45, -124.65, 39.01,  64.18),  useJob = true,  job = {"mechanic5"}},    -- Mekanik 5
    [52] = {coords = vector4(-349.21, -131.56, 39.01,  64.18),  useJob = true,  job = {"mechanic5"}},    -- Mekanik 5
