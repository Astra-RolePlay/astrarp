window.onload = function(e)
{
    ...
    function populateMenu(menu, id, item, item2, r, g, b)
    {
        ...
        if(item2 == "none")
        {
            $("." + menu).append("<li class = '" + id + "' r = '" + r +"' g = '" + g + "' b = '" + b + "'><span class = 'item1'>" + item + "</span></li>");
        }
        else
        {
            $("." + menu).append("<li class = '" + id + "' r = '" + r +"' g = '" + g + "' b = '" + b + "'><span class = 'item1'>" + item + "</span> <span class = 'item2' style = 'float: right;'>" + item2 + "</span></li>");
        }
    }
    ...
    function toggleMenu(state, menu)
    {
        if(state)
        {
            if(menuStructure[menu].selectedItem < maxMenuItems)
            {
                ...
                var r = $("." + menu + " .item_selected").attr("r").split(" ")[0];
                var g = $("." + menu + " .item_selected").attr("g").split(" ")[0];
                var b = $("." + menu + " .item_selected").attr("b").split(" ")[0];
