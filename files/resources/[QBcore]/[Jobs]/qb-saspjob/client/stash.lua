...
-- Depo Event
RegisterNetEvent('qb-saspjob:OpenStash', function(data)
...
RegisterNetEvent('qb-saspjob:Dna', function()
    local Menu = {
        {
            header = "DNA Deposu",
            isMenuHeader = true,
...
RegisterNetEvent('qb-saspjob:Kanit', function()
    local Menu = {
        {
            header = "Kanıt Deposu",
            isMenuHeader = true,
...
RegisterNetEvent('qb-saspjob:client:Charge', function()
    ...
    if dialog then
        ...
        TriggerServerEvent('qb-saspjob:server:Charge', dialog.citizen, dialog.price)
    end
end)