...
RegisterNetEvent("qb-sheriff:client:openStash", function()
    TriggerServerEvent("inventory:server:OpenInventory", "stash", "Sheriff_"..QBCore.Functions.GetPlayerData().citizenid)
    TriggerEvent("inventory:client:SetCurrentStash", "Sheriff_"..QBCore.Functions.GetPlayerData().citizenid)
end)
