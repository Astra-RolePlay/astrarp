...
-- Depo Event
RegisterNetEvent('qb-sheriffjob:OpenStash', function(data)
...
RegisterNetEvent('qb-sheriffjob:Dna', function()
    local Menu = {
        {
            header = "DNA Deposu",
            isMenuHeader = true,
...
RegisterNetEvent('qb-sheriffjob:Kanit', function()
    local Menu = {
        {
            header = "Kanıt Deposu",
            isMenuHeader = true,
...
RegisterNetEvent('qb-sheriffjob:client:Charge', function()
    ...
    if dialog then
        ...
        TriggerServerEvent('qb-sheriffjob:server:Charge', dialog.citizen, dialog.price)
    end
end)