Citizen.CreateThread(function()
	for k, v in pairs(Chairs) do
		exports['qb-target']:AddBoxZone("CatChair"..k, v.location, v.width, v.height, { name="CatChair"..k, heading = v.heading, debugPoly=false, minZ = v.minZ, maxZ = v.maxZ, }, 
			{ options = { { event = "qb-uwu:Chair", icon = "fas fa-chair", label = "Otur", loc = v.location, head = v.heading }, },
			  distance = v.distance
		})
	end
end)
