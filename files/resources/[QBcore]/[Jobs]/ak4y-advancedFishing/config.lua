...
Config.Language = {
    ...
    ["youDontHaveEnoughSpace"] = "You do not have enough space to move the item!",
    ["youDontHaveWantSell"] = "You don't have the product you want to sell!",
    ["succesBuy"] = "You have purchased: ",
    ["succesSold"] = "You sold: ",
}
...
Config.fishMenuArea = { -- GO NEXT TO IT AND PRESS E TO OPEN THE /FISH MENU
    {
        pedName = "AKAY", 
        pedHash = 0x0B881AEE, 
        pedCoord = vector3(-1835.36, -1233.94, 12.02),
...
Config.upgradeRodArea = { -- ROD LEVEL UPGRADE AREAS
    {
        pedName = "Rosetta", 
        pedHash = 0x1EEC7BDC, 
        pedCoord = vector3(-1854.62, -1218.41, 12.11), 
...
Config.marketArea = { -- MARKET AREAS (BUYING AND SELLING)
    {
        pedName = "Rosetta", 
        pedHash = 0xAE5BE23A, 
        pedCoord = vector3(-1796.08, -1200.56, 12.02), 
...
Config.Tasks = { -- TASKS APPEARING ON THE FISH MENU
     ...
     },
     {
         ...
         taskName = "Catch 20 Acorns", -- NAME OF THE TASK AS IT APPEARS IN THE MENU
...
Config.Fishes = { -- /FISH MENU SETTINGS
   {
     ...
     },
     {
         ...
         fishName = "Acorn", -- THE APPARENT NAME OF THE FISH
     ...
     },
     {
         ...
         description = "You can catch this fish in the sea, don't catch this fish"
     },
     {
