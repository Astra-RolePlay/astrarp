...
var quotes = [
  'Belediye başkanları doğrudan valiye bağlıdır.',
  'Tüm kolluk kuvvetleri bölgesinde bulunan belediye başkanına bağlıdır.',
  'Adalet Bakanlığı kolluk kuvvetlerini, belediye başkanlarını ve valiyi denetlemekle yükümlüdür.',
  'FIB, Adalet Bakanlığı tarafından görevlendirilmiş tam yetkili soruşturma ve uygulama birimidir.',
  'Tüm birimler bölgesinde bulunan belediye başkanına doğrudan bağlıdır.',
  'Tüm departman ve birimler üzerinde tam yetkiye sahip olan tek birim Adalet Bakanlığı\'dır.',
  'US Marshall biriminin tek amacı hakim, savcı, belediye başkanları ve valiyi korumaktır.'
]
...
$(document).ready(() => {
  ...
  $(".profile-items").on("click", ".profile-item", async function () {
    ...
    $(".manage-profile-editing-title").html(`${result["firstname"]} ${result["lastname"]} isimli vatandaşın kaydını güncelliyorsun.`);
    ...
    let licencesHTML = '<div style="color: #fff; text-align:center;">Belge bulunamadı...</div>';
    let tagsHTML = '<div style="color: #fff; text-align:center;">Etiket bulunamadı...</div>';
    let convHTML = '<div style="color: #fff; text-align:center;">Hüküm veya ceza bulunamadı...</div>';
    let vehHTML = '<div style="color: #fff; text-align:center;">Araç kaydı bulunamadı...</div>';
    let galleryHTML = '<div style="color: #fff; text-align:center;">Fotoğraf bulunamadı...</div>';
    let propertyHTML = '<div style="color: #fff; text-align:center;">Ev kaydı bulunamadı...</div>';
    ...
    if (canCreateBulletin == 0) {
      ...
      $(".bulletin-items-continer")
        .prepend(`<div class="bulletin-item" data-id="${canCreateBulletin}">
                ...
                <div class="bulletin-date">${MyName} - Şimdi</div>
                </div>
            </div>`);
    } else {
  ...
  $(".manage-incidents-title-holder").on(
    ...
    function () {
      let tempalte =
        "📝 Olay Anlatımı:\n\n[Olayın detaylarını buraya yazın...]\n\n🧍Rehineler:\n\n[Rehinelerin isimlerini buraya yazın...]\n\n🔪 El Konulan Eşya ve Silahlar:\n\n· [Kayıt altına alınması için el konulan eşyaların listesini buraya yazın...]\n\n-----\n💸 Ceza: \n⌚ Hapis: \n-----";
      ...
      $(".manage-incidents-title-holder").prepend(
        `
            <div class="manage-incidents-title">Olay Kaydı Yönetimi</div>
      ...
      $(".manage-incidents-editing-title").html(
        "Şu an yeni bir olay kaydı oluşturuyorsun..."
      );
    ...
    let args = [
      {
        ...
        icon: "fas fa-car",
        text: "Araç Bilgilerini GÖrüntüle",
      ...
      $(".incidents-ghost-holder").prepend(
        `
          ...
          this
                ...
                <div class="manage-incidents-title-tag" data-id="${$(this).data(
          "cid"
        )}">Uygulanan Ceza Tutarı</div>
                <div class="associated-incidents-fine-input" data-id="${$(
          this
        ).data(
          "cid"
        )}"><img src="https://i.imgur.com/h7S5f9J.png"> <input placeholder="Para cezasını buraya ekleyin" value="0" class="fine-amount" data-id="${$(
          this
        ).data("cid")}" type="number"></div>
                <div class="manage-incidents-title-tag" data-id="${$(this).data(
          "cid"
        )}">Uygulanan Hapis Süresi (Ay)</div>
                <div class="associated-incidents-sentence-input" data-id="${$(
          this
        ).data(
          "cid"
        )}"><img src="https://i.imgur.com/9Xn6xXK.png"> <input placeholder="Hapis-Kamu cezasını buraya ekleyin" value="0" class="sentence-amount" data-id="${$(
          this
        ).data("cid")}" type="number"></div>
            </div>
            `
                            ...
                            <div style="display: flex; flex-direction: column;">
                                <div class="dmv-item-title">${value.model}</div>
                                    <div class="dmv-tags">
                                        ...
                                        <div class="dmv-tag ${impound}">Bağlanmış</div>
                                        <div class="dmv-tag ${bolo}">Aranıyor</div>
                                        <div class="dmv-tag ${stolen}">Çalıntı</div>
                                        <div class="dmv-tag ${codefive}">Gözetim Altında</div>
                                    </div>
                                </div>
                                <div class="dmv-bottom-info">
                                    <div class="dmv-id">Plaka: ${value.plate} · Sahibi: ${value.owner}</div>
                                </div>
                            </div>
                        </div>
                    `;
        ...
        args = [
          {
            ...
            icon: "fas fa-check",
            text: "Gözetim Altında Olarak İşaretle",
            info: plate,
            status: "",
          },
        ];
        ...
        args = [
          {
            ...
            icon: "fas fa-times",
            text: "Gözetim Altında Durumunu İptal Et",
            info: plate,
            status: "",
          },
        ];
        ...
        args = [
          {
            ...
            icon: "fas fa-times",
            text: "Çalıntı Durumunu İptal Et",
            info: plate,
            status: "",
          },
        ];
        ...
        args = [
          {
            ...
            icon: "fas fa-times",
            text: "Bağlama İşlemini İptal Et",
            info: plate,
            status: "",
          },
          {
            ...
            text: "Bağlanma Raporunu Görüntüle",
            info: plate,
            status: "",
          },
        ];
    ...
    args = [
      {
        ...
        icon: "far fa-eye",
        text: "Vatandaş Kaydını Görüntüle",
        info: $(this).data("cid"),
        status: "",
      },
      {
    ...
    if (cid) {
      args = [
        ...
        },
        {
          ...
          text: "Telsiz Frekansını Değiştir",
          info: cid,
          status: "",
        },
        {
        ...
        if (canRespond == true) {
          args = [
            ...
            },
            {
              ...
              text: "İntikal Etme Durumunu Geri Al",
              info: callId,
              status: "",
            },
            {
  ...
  function JobColors(sentJob) {
    if (sentJob) {
      if (PoliceJobs[sentJob] !== undefined) {
        ...
        $(".badge-logo").attr("src", "img/mayor.png");
        $(".header-title").html("LOS SANTOS VALİLİĞİ");
        $(".bolo-nav-item").html("Arantı Kayıtları");
        $(".bolos-search-title").html("Arantı Kaydı Ara");
        $("#bolos-search-input").attr("placeholder", "Vatandaş ismi veya araç plakası girin...");
        $(".manage-bolos-title").html("Arantı Kaydı Yönetimi");
        $(".manage-bolos-editing-title").html(
          "Yeni bir arantı kaydı oluşturmak için aşağıdaki alanları doldurup ardından kaydedebilirsin."
        );
        $(".boloplate-title").html("Plaka");
        $(".boloowner-title").html("Araç Sahibi");
        $(".boloindividual-title").html("Araç İçindekiler");
        $("#boloplate").attr("placeholder", "Bu alana araç plakasını girin...");
        $("#bolodetail").attr(
          "placeholder",
          "Bu alana arantı kaydı detayını girin..."
        );
        $("#boloowner").attr(
          "placeholder",
          "Bu alana aranan araç sahibinin tam ismini girin..."
        );
        $("#boloindividual").attr(
          "placeholder",
          "Bu alana araç içerisindeki kişileri girin..."
        );
        ...
        $(".dmv-nav-item").show();
        $(".cams-nav-item").show();
        $(".dispatch-title-ofsomesort").html("Mesaj Paneli");
    ...
    /* } else if (eventData.type == "bulletin") {
      ...
      $(".bulletin-items-continer")
        .prepend(`<div class="bulletin-item" data-id=${value.id}>
                ...
                <div class="bulletin-bottom-info">
                    <div class="bulletin-id">Duyuru No: ${value.id}</div>
      ...
      $.each(eventData.data, function (index, value) {
        $('.warrants-items').prepend(`<div class="warrants-item" data-cid=${value.cid} data-id=${value.linkedincident}><div style="display: flex; flex-direction: column; margin-top: 2.5px; margin-left: 0.75vh; width: 100%;">
            ...
            <div class="warrant-bottom-info">
                <div class="warrant-id">Olay No: ${value.linkedincident}</div>
            </div>
        </div></div>`)
    })
        ...
        $(".incidents-items").append(
          `<div class="incidents-item" data-id="${value.id}">
                    <div class="incidents-top-holder">
                        ...
                        <div class="incedent-report-name">Olay Kaydı</div>
                    </div>
                    <div class="incidents-bottom-holder">
                        <div class="incedent-report-id">Olay No: ${value.id}</div>
        ...
        $.each(value, function (i, v) {
          $(`#penal-${index}`).append(`
                    ...
                    <div style="display: flex; flex-direction: row; width: 100%; margin: auto; margin-bottom: 0vh; padding-top: 0.75vh;">
                        ...
                        <div class="offfense-item-months">${v.months} Süre - $${v.fine}</div>
                    </div>
                    `);
        });
      });
      ...
      $(".manage-incidents-editing-title").html(
        "("+ table["id"] + ") numaralı olay kaydını güncelliyorsun. Yaptığın her değişiklikten sonra dosyayı kaydetmeyi unutma!"
      );
        ...
        if (value.associated == 1) {
          $(".incidents-ghost-holder").prepend(
            `<div class="associated-incidents-user-container" data-id="${value.cid}">
                            ...
                            <div class="manage-incidents-title-tag" data-id="${value.cid}" style="display:none;">Önerilen Ceza Tutarı</div>
                            ...
                            <div class="manage-incidents-title-tag" data-id="${value.cid}" style="display:none;">Önerilen Hapis Süresi (Ay)</div>
                            ...
                            <div class="manage-incidents-title-tag" data-id="${value.cid}" style="display:none;">Uygulanan Ceza Tutarı</div>
                            ...
                            <div class="manage-incidents-title-tag" data-id="${value.cid}" style="display:none;">Uygulanan Hapis Süresi (Ay)</div>
          ...
          $(".incidents-ghost-holder").prepend(
            `<div class="associated-incidents-user-container" data-id="${value.cid}">
                            ...
                            <div class="manage-incidents-title-tag" data-id="${value.cid}">Önerilen Ceza Tutarı</div>
                            ...
                            <div class="manage-incidents-title-tag" data-id="${value.cid}">Önerilen Hapis Süresi (Ay)</div>
                            ...
                            <div class="manage-incidents-title-tag" data-id="${value.cid}">Uygulanan Ceza Tutarı</div>
                            ...
                            <div class="manage-incidents-title-tag" data-id="${value.cid}">Uygulanan Hapis Süresi (Ay)</div>
          ...
          `
                    <div class="icidents-person-search-item" data-info="${name} (#${value.id})" data-cid="${value.id}" data-name="${name}">
                        ...
                        <div class="icidents-person-search-item-right">
                            <div class="icidents-person-search-item-right-cid-title">Kimlik No</div>
                            <div class="icidents-person-search-item-right-cid-input"><span class="fas fa-id-card"></span> ${value.id}</div>
                            <div class="icidents-person-search-item-right-name-title">İsim</div>
      ...
      let table = eventData.data;
      $(".manage-bolos-editing-title").html(
        "(" + table["id"] + ") numaralı arantı kaydını güncelliyorsun. Yaptığın her değişiklikten sonra dosyayı kaydetmeyi unutma!"
      );
        ...
        $(".bolos-items").prepend(
          `<div class="bolo-item" data-id="${value.id}">
                    ...
                    <div class="bolo-bottom-holder">
                        <div class="bolo-report-id">Arantı No: ${value.id}</div>
        ...
        $(".reports-items").append(
          `<div class="reports-item" data-id="${value.id}">
                    ...
                    <div class="reports-bottom-holder">
                        <div class="reports-report-id">Rapor No: ${value.id}</div>
      ...
      $(".manage-reports-editing-title").html(
        "(" + table["id"] + ") numaralı raporu güncelliyorsun. Yaptığın her değişiklikten sonra dosyayı kaydetmeyi unutma!"
      );
      ...
      $(".vehicle-tags").append(
        `<div class="vehicle-tag ${impound} impound-tag">Bağlanmış</div>`
      );
      $(".vehicle-tags").append(
        `<div class="vehicle-tag ${bolo}">Aranıyor</div>`
      );
      $(".vehicle-tags").append(
        `<div class="vehicle-tag ${codefive} code5-tag">Gözetim Altında</div>`
      );
      $(".vehicle-tags").append(
        `<div class="vehicle-tag ${stolen} stolen-tag">Çalıntı</div>`
      );
      $(".vehicle-info-imageurl-input").val(table["image"]);
    ...
    profileHTML += `
                  <div class="profile-item" data-id="${value.citizenid}">
                      ...
                      <div style="display: flex; flex-direction: column;">
                          ...
                          <div class="profile-bottom-info">
                              <div class="profile-id">Kimlik No: ${value.citizenid}</div>&nbsp;
                          </div>
                      </div>
                  </div>
              `;
