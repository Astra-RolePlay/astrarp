...
$(document).on("keydown", function () {
    switch (event.keyCode) {
        case 27: // ESC
            $.post("https://qb-fishing/closeMenu", JSON.stringify());
            ...
            if (gameActive) {
                keyGameStop();
                $.post("https://qb-fishing/failGame", JSON.stringify());
            }
            break;
    }
});
                ...
                <div class="canCatchSection" id="${CCStateID}"> ${CCState} </div>
                    ...
                    <div class="middleItemRequired">
                        <div class="middleItemTypeSection">
                            <div class="middleItemType" id="middleFishType">Tipi:</div>
                            <div class="middleItemTypeName" id="${type}">${element.fishType}</div>
                        </div>
                        <div class="middleItemRequiredRod">
                            <div class="middleItemRequiredRodType" id="middleFishingRodReq">Olta Seviyesi:</div>
            ...
            recentEvent =
                ...
                `
                    <div class="sellmiddleItem">
                        ...
                        <div class="sellItemName">${element.fishName}</div>
                        <div class="sellItemBottom">
                            <div class="sellItemCannotSell">Yetersiz Seviye</div>
                        </div>
                    </div>
                    `;
        }
    ...
    if (keys.some((keyObj) => keyObj.key === key)) {
        ...
        if (correctCount >= 5) {
            if (gameActive) {
                ...
                setTimeout(() => {
                    keyGameStop();
                    $.post("https://qb-fishing/successGame", JSON.stringify());
                }, 150);
            }
        }
    } else {
