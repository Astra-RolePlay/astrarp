...
-- Depo Event
RegisterNetEvent('qb-policejob:OpenStash', function(data)
...
RegisterNetEvent('qb-policejob:Dna', function()
    local Menu = {
        {
            header = "DNA Deposu",
            isMenuHeader = true,
...
RegisterNetEvent('qb-policejob:Kanit', function()
    local Menu = {
        {
            header = "Kanıt Deposu",
            isMenuHeader = true,
...
RegisterNetEvent('qb-policejob:client:Charge', function()
    ...
    if dialog then
        ...
        TriggerServerEvent('qb-policejob:server:Charge', dialog.citizen, dialog.price)
    end
end)