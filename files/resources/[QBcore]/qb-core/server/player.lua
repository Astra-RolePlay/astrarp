...
function QBCore.Player.CheckPlayerData(source, PlayerData)
    ...
    PlayerData.metadata["commandbinds"] = PlayerData.metadata["commandbinds"] ~= nil and
        PlayerData.metadata["commandbinds"] or {}
...
function QBCore.Player.CreatePlayer(PlayerData, Offline)
    ...
    function self.Functions.AddMoney(moneytype, amount, reason)
        ...
        if not self.Offline then
            ...
            if amount > 100000 then
                TriggerEvent('qb-log:server:CreateLog', 'playermoney', 'Para Geldi', 'lightgreen',
                    '**' ..
                    ...
                    moneytype ..
                    ') Eklendi, ' ..
                    moneytype .. ' Güncel Bakiye: ' .. self.PlayerData.money[moneytype] .. ' Sebep: ' .. reason, true)
            else
                TriggerEvent('qb-log:server:CreateLog', 'playermoney', 'Para Geldi', 'lightgreen',
                    '**' ..
                    GetPlayerName(self.PlayerData.source) ..
                    ...
                    moneytype ..
                    ') Eklendi,  ' ..
                    moneytype .. ' Güncel Bakiye: ' .. self.PlayerData.money[moneytype] .. ' Sebep: ' .. reason)
            end
    ...
    function self.Functions.RemoveMoney(moneytype, amount, reason)
        ...
        if not self.Offline then
            self.Functions.UpdatePlayerData()
            if amount > 100000 then
                TriggerEvent('qb-log:server:CreateLog', 'playermoney', 'Para Gitti', 'red',
                    '**' ..
                    GetPlayerName(self.PlayerData.source) ..
                    ' (Citizenid: ' ..
                    self.PlayerData.citizenid ..
...
function QBCore.Functions.CreateAccountNumber()
    ...
    while not UniqueFound do
        AccountNumber = '' ..
            math.random(1, 9) .. '' .. math.random(1111, 9999) .. math.random(1111, 9999) .. math.random(11, 99)
...
function QBCore.Functions.CreatePhoneNumber()
    ...
    while not UniqueFound do
        PhoneNumber = math.random(100, 999) .. math.random(111, 999)
...
function QBCore.Player.CreateSerialNumber()
    ...
    while not UniqueFound do
        SerialNumber = math.random(1111, 9999)
    ...
    if not self.Offline then
        ...
        if amount > 100000 then
            TriggerEvent('qb-log:server:CreateLog', 'playermoney', 'AddMoney', 'lightgreen',
                ...
                ' (' ..
                moneytype ..
                ') added, new ' .. moneytype .. ' balance: ' .. self.PlayerData.money[moneytype] .. ' reason: ' .. reason,
                true)
        else
            TriggerEvent('qb-log:server:CreateLog', 'playermoney', 'AddMoney', 'lightgreen',
                '**' ..
...
function self.Functions.SetMoney(moneytype, amount, reason)
    ...
    if not self.Offline then
        ...
        TriggerEvent('qb-log:server:CreateLog', 'playermoney', 'SetMoney', 'green',
            ...
            self.PlayerData.source ..
            ')** $' ..
            amount .. ' (' .. moneytype .. ') set, new ' .. moneytype .. ' balance: ' .. self.PlayerData.money
            [moneytype])
    end
