...
BQ.EnumerateEntities = function(initFunc, moveFunc, disposeFunc)
...
BQ.GetClosestVehicle = function(coords)
    local vehicles        = BQ.GetVehicles()
...
BQ.GetPlayersInArea = function(coords, area)
    local players, playersInArea = BQ.GetPlayers(), {}
...
BQ.GetPlayersFromCoords = function(coords, distance)
...
BQ.GetClosestPlayer = function()
    local closestPlayers = BQ.GetPlayersFromCoords()
    local closestDistance = -1
...
BQ.DrawText3D = function(x, y, z, text)
...
-- RegisterCommand('itemyenile', function()
--     TriggerServerEvent('inventory:UpdateAddonItems')
-- end)

RegisterNetEvent("QBCore:Client:OnPlayerLoaded")
AddEventHandler("QBCore:Client:OnPlayerLoaded", function()
    TriggerServerEvent('inventory:GetAddonItems')
end)

AddonItems = {}
RegisterNetEvent('inventory:SetAddonItems')
AddEventHandler('inventory:SetAddonItems', function(addonItems)
    AddonItems = addonItems
    -- print("client data: ", json.encode(AddonItems))
    SendNUIMessage({
        action = "updateAddonItems",
        data = AddonItems
    })
end)
...
RegisterNUICallback('GetNearPlayers', function(data, cb)
    local playerPed = PlayerPedId()
    local players, nearbyPlayer = BQ.GetPlayersInArea(GetEntityCoords(playerPed), 2.0)
    local player, distance = BQ.GetClosestPlayer()
