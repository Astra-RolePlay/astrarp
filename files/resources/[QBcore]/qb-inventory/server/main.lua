		...
		if name and id then
			...
			elseif name == "otherplayer" then
				...
				if Drops[id] and not Drops[id].isOpen then
					...
					secondInv.name = id
					secondInv.label = "Yerde-"..tostring(id)
...
AddonItems = {}
RegisterServerEvent('inventory:UpdateAddonItems')
AddEventHandler('inventory:UpdateAddonItems', function(addonItems)
    AddonItems = addonItems
	-- print("data:", json.encode(addonItems))
    TriggerClientEvent('inventory:SetAddonItems', -1, AddonItems)
end)

RegisterServerEvent('inventory:GetAddonItems')
AddEventHandler('inventory:GetAddonItems', function()
	-- print("data returning: ", json.encode(AddonItems))
    TriggerClientEvent('inventory:SetAddonItems', source, AddonItems)
end)
        ...
        elseif QBCore.Shared.SplitStr(fromInventory, "-")[1] == "itemshop" then
            ...
            if QBCore.Shared.SplitStr(shopType, "_")[1] == "Dealer" then
                if QBCore.Shared.SplitStr(itemData.name, "_")[1] == "weapon" then
                    ...
                    if Player.Functions.RemoveMoney("cash", price, "dealer-item-bought") then
                        ...
                        TriggerClientEvent('QBCore:Notify', src, itemInfo["label"] .. " Satın Aldın!", "success")
            ...
            elseif QBCore.Shared.SplitStr(shopType, "_")[1] == "market" then
                if Player.Functions.RemoveMoney("blackmoney", price, "blackmarket-item-bought") then
                    ...
                    QBCore.Functions.Notify(src, itemInfo["label"] .. " Satın Aldın!", "success")
...
QBCore.Commands.Add("invresetle", "Reset Inventory (Admin Only)", {{name="type", help="stash/trunk/glovebox"},{name="id/plate", help="ID of stash or license plate"}}, true, function(source, args)
...
QBCore.Commands.Add("soy", "Vatandaşın Üzerini Ara", {}, false, function(source, _)
	TriggerClientEvent("police:client:RobPlayer", source)
end)

QBCore.Commands.Add("itemver", "Bir Öğe Ver (Yalnızca Yönetici)", {{name="id", help="Player ID"},{name="item", help="Name of the item (not a label)"}, {name="amount", help="Amount of items"}}, false, function(source, args)
...
QBCore.Commands.Add("rastgeleitemver", "Rastgele Öğeler Ver (Yalnızca God)", {}, false, function(source, _)
	local filteredItems = {}
...
QBCore.Commands.Add('envantersil', 'Oyuncu Envanterini Temizle (Yalnızca Yönetici)', { { name = 'id', help = 'Player ID' } }, false, function(source, args)
