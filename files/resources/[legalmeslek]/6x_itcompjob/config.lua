...
Config.BlipName = 'LA Bilgisayar' -- For calls
Config.BlipName2 = 'LA Bilgisayar HQ'
Config.BlipLocation = vector3(-827.46, -689.94, 28.06)
Config.BlipName3 = 'Bilgisayar Mağazası'
...
local items = { itemmonitor, "6x_keyboard", "6x_mouse", "6x_compcase", "6x_powersupplie", "6x_cpu", "6x_cpucooler",
    "6x_motherboard", "6x_memory", "6x_graphiccard", "6x_ssd", "6x_cables" }
Config.DeliveryItem = items[math.random(1, #items)]

Config.Payout = math.random(1000, 1001)
Config.Job = 'itcomp'
