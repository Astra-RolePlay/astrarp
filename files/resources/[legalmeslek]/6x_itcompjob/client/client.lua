...
Citizen.CreateThread(function()
    ...
    exports['qb-target']:AddCircleZone('Entry',
        vector3(missionTarget.location.x, missionTarget.location.y, missionTarget.location.z), 0.8, {
        name = 'Entry',
        debugPoly = false,
        useZ = true
    }, {
...
Citizen.CreateThread(function()
    ...
    exports['qb-target']:AddCircleZone('Exit',
        vector3(missionTarget.inside.x, missionTarget.inside.y, missionTarget.inside.z), 0.8, {
        name = 'Exit',
        debugPoly = false,
        useZ = true
    }, {
