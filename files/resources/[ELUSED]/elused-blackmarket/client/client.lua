...
RegisterNetEvent('elused-blackmarket:stash')
AddEventHandler('elused-blackmarket:stash',function(data)
	id = data.stash
...
Citizen.CreateThread(function()
	...
	exports['qb-target']:AddBoxZone("GunnerShop", vector3(14.07, -1100.38, 29.8), 0.4, 2.8, { name="GunnerShop", heading = 340, debugPoly = false, minZ = 25.7, maxZ = 29.7 }, 
		{ options = { {  event = "elused-blackmarket:shops", icon = "fas fa-box-open", label = "Silah Parçası Al", job = "gunner" }, },
		  distance = 2.0
	})
    ...
    exports['qb-target']:AddBoxZone("GunnerDepo", vector3(16.76, -1105.09, 29.8), 0.6, 5.6, { name="GunnerDepo", heading = 340, debugPoly = false, minZ = 27.85, maxZ = 31.85 }, 
        { options = { {  event = "elused-blackmarket:stash", icon = "fas fa-box-open", label = "Depo", stash = "Depo_1", job = "gunner" }, },
         distance = 2.5
    })
    ...
    exports['qb-target']:AddBoxZone("GunnerTezgah", vector3(16.61, -1108.33, 29.8), 1.0, 4.8, { name="GunnerTezgah", heading = 340, debugPoly = false, minZ = 28.8, maxZ = 30.4 }, 
        { options = { {  event = "elused-blackmarket:stash", icon = "fas fa-box-open", label = "Tezgah", stash = "Tezgah_1" }, },
         distance = 2.5
    })
	...
	exports['qb-target']:AddBoxZone("GunnerShop2", vector3(253.61, -50.66, 69.94), 0.9, 1.4, { name="GunnerShop2", heading = 340, debugPoly = false, minZ = 67.14, maxZ = 71.14 }, 
		{ options = { {  event = "elused-blackmarket:shops", icon = "fas fa-box-open", label = "Silah Parçası Al", job = "gunner2" }, },
		  distance = 2.0
	})
    ...
    exports['qb-target']:AddBoxZone("GunnerDepo2", vector3(248.77, -53.98, 69.94), 0.6, 5.2, { name="GunnerDepo2", heading = 340, debugPoly = false, minZ = 68.89, maxZ = 71.49 }, 
        { options = { {  event = "elused-blackmarket:stash", icon = "fas fa-box-open", label = "Depo", stash = "Depo_2", job = "gunner2" }, },
         distance = 2.5
    })
    ...
    exports['qb-target']:AddBoxZone("GunnerTezgah2", vector3(248.43, -51.01, 69.94), 1.15, 3.65, { name="GunnerTezgah2", heading = 340, debugPoly = false, minZ = 66.24, maxZ = 70.24 }, 
        { options = { {  event = "elused-blackmarket:stash", icon = "fas fa-box-open", label = "Tezgah", stash = "Tezgah_2" }, },
         distance = 2.5
    })
	...
	exports['qb-target']:AddBoxZone("GunnerShop3", vector3(-1302.54, -391.65, 36.7), 1.6, 0.8, { name="GunnerShop3", heading = 349, debugPoly = false, minZ = 35.7, maxZ = 36.9 }, 
		{ options = { {  event = "elused-blackmarket:shops", icon = "fas fa-box-open", label = "Silah Parçası Al", job = "gunner3" }, },
		  distance = 2.0
	})
    ...
    exports['qb-target']:AddBoxZone("GunnerDepo3", vector3(-1308.89, -396.52, 36.7), 0.6, 5.2, { name="GunnerDepo3", heading = 346, debugPoly = false, minZ = 35.55, maxZ = 37.55 }, 
        { options = { {  event = "elused-blackmarket:stash", icon = "fas fa-box-open", label = "Depo", stash = "Depo_3", job = "gunner3" }, },
         distance = 2.5
    })
    ...
    exports['qb-target']:AddBoxZone("GunnerTezgah3", vector3(-1309.19, -393.78, 36.7), 1.2, 3.6, { name="GunnerTezgah3", heading = 346, debugPoly = false, minZ = 35.7, maxZ = 36.9 }, 
        { options = { {  event = "elused-blackmarket:stash", icon = "fas fa-box-open", label = "Tezgah", stash = "Tezgah_3" }, },
         distance = 2.5
    })

    --Gunner 4
	exports['qb-target']:AddBoxZone("GunnerShop4", vector3(-662.09, -933.73, 21.83), 1.4, 1.0, { name="GunnerShop4", heading = 0, debugPoly = false, minZ = 20.83, maxZ = 23.03 }, 
		{ options = { {  event = "elused-blackmarket:shops", icon = "fas fa-box-open", label = "Silah Parçası Al", job = "gunner4" }, },
		  distance = 2.0
	})

    exports['qb-target']:AddBoxZone("GunnerDepo4", vector3(-657.32, -937.16, 21.83), 5.2, 0.6, { name="GunnerDepo4", heading = 0, debugPoly = false, minZ = 20.83, maxZ = 22.63 }, 
        { options = { {  event = "elused-blackmarket:stash", icon = "fas fa-box-open", label = "Depo", stash = "Depo_4", job = "gunner4" }, },
         distance = 2.5
    })

    exports['qb-target']:AddBoxZone("GunnerTezgah3", vector3(-659.97, -938.44, 21.83), 3.6, 1.2, { name="GunnerTezgah4", heading = 0, debugPoly = false, minZ = 20.83, maxZ = 22.63 }, 
        { options = { {  event = "elused-blackmarket:stash", icon = "fas fa-box-open", label = "Tezgah", stash = "Tezgah_4" }, },
         distance = 2.5
    })
...
local function OpenWeaponCraftingMenu()
    ...
    for k, v in pairs(Config.Weapons) do
        ...
        item.text = text
        item.params = {
            event = 'elused-blackmarket:client:craftWeapon',
            args = {
                type = k
            }
        }
...
local function OpenAmmoCraftingMenu()
    ...
    for k, v in pairs(Config.Ammo) do
        ...
        item.text = text
        item.params = {
            event = 'elused-blackmarket:client:craftAmmo',
            args = {
                type = k
            }
        }
...
local function OpenAttachmentCraftingMenu()
    ...
    for k, v in pairs(Config.Attachment) do
        ...
        item.text = text
        item.params = {
            event = 'elused-blackmarket:client:craftAttachment',
            args = {
                type = k
            }
        }
...
local function CraftWeapon(weapon)
    QBCore.Functions.Progressbar('crafting_weapon', Config.Weapons[weapon].label..' Üretiliyor', 4000, false, false, {
        ...
        TriggerServerEvent('elused-blackmarket:server:craftWeapon', Config.Weapons[weapon].hash)
        for k, v in pairs(Config.Weapons[weapon].materials) do
             TriggerServerEvent('elused-blackmarket:server:RemoveItem', v.item, v.amount)
...
local function CraftAmmo(ammo)
    QBCore.Functions.Progressbar('crafting_ammo', Config.Ammo[ammo].label..' Üretiliyor', 4000, false, false, {
        ...
        TriggerServerEvent('elused-blackmarket:server:craftAmmo', Config.Ammo[ammo].hash)
...
local function CraftAttachment(attachment)
    QBCore.Functions.Progressbar('crafting_attachment', Config.Attachment[attachment].label..' Üretiliyor', 4000, false, false, {
        ...
        TriggerServerEvent('elused-blackmarket:server:craftAttachment', Config.Attachment[attachment].hash)
...
RegisterNetEvent('elused-blackmarket:client:craftWeapon', function(data)
    QBCore.Functions.TriggerCallback("elused-blackmarket:server:enoughMaterials", function(hasMaterials)
...
RegisterNetEvent('elused-blackmarket:client:craftAmmo', function(data)
    QBCore.Functions.TriggerCallback("elused-blackmarket:server:enoughMaterials", function(hasMaterials)
        if (hasMaterials) then
            CraftAmmo(data.type)
        else
...
RegisterNetEvent('elused-blackmarket:client:craftAttachment', function(data)
    QBCore.Functions.TriggerCallback("elused-blackmarket:server:enoughMaterials", function(hasMaterials)
        if (hasMaterials) then
...
CreateThread(function()
    for k,v in pairs(Config.JobLocation4) do
        for k, v in pairs(v) do 
            exports['qb-target']:AddBoxZone(v.name, v.loc, v.length, v.width, {
                name = v.name,
                heading = v.heading,
