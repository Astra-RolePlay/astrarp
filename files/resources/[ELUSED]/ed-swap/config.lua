...
Config.engineLocations = {
  ["customsMain"] = { -- THis name should be unique no duplicates
    ["coords"] = vector3(386.02, -1154.76, 29.29), -- The coords of the zone
    ["size"] = 2.0, -- How big is the zone?
    ["heading"] = 0.0, -- Heading
    ["debug"] = false, -- Should zone be debugged?
    ["authorizedJob"] = "police", -- job authorized to engine swap
    ["inVehicle"] = "[E] Egzoz Değiştir ", -- The name if a user is in a vehicle
    ["outVehicle"] = "Bir araçta olmanız gerekiyor!", -- Message if user is not in a vehicle
  },
  ["Hayesauto"] = { -- THis name should be unique no duplicates
    ...
    ["heading"] = 0.0, -- Heading
    ["debug"] = false, -- Should zone be debugged?
    ["authorizedJob"] = "lscustom", -- job authorized to engine swap
    ["inVehicle"] = "[E] Egzoz Değiştir ", -- The name if a user is in a vehicle
    ["outVehicle"] = "Bir araçta olmanız gerekiyor!", -- Message if user is not in a vehicle
  },
}
