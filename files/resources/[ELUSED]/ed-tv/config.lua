...
Config['Objects'] = {
    ...
    },
    {
        ...
        ['Scale'] = 0.069,
        ['Offset'] = vec3(-1.27, -0.055, 0.75),
        ['Distance'] = 15.5,
    },
}

Strings = {
    ['VideoHelp'] = 'Bir video oynamak için ~b~/tv ~y~youtube id~s~ \nÖrnek: ~b~/tv ~y~3hqjseATp4g~s~',
    ['VolumeHelp'] = 'Sesi değiştirmek için ~b~/volume ~y~(0-10)~s~ \nÖrnek: ~b~/volume ~y~5~s~\n\nVideoyu değiştirmek için ~b~/tv ~y~youtube id~s~ \nÖrnek: ~b~/tv ~y~3hqjseATp4g~s~\n\nVideoyu durdurmak için ~b~/destroy~s~ \n\n~INPUT_CONTEXT~ Video zamanını senkronize et',
}