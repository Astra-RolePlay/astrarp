...
RegisterServerEvent('ed-tv:add')
AddEventHandler('ed-tv:add', function(url, object, coords, scale, offset)
    ...
    TriggerClientEvent('ed-tv:update', -1, tosend)
end)

RegisterServerEvent('ed-tv:fetch')
AddEventHandler('ed-tv:fetch', function()
    local tosend = {}
    ...
    TriggerClientEvent('ed-tv:update', source, tosend)
end)

RegisterServerEvent('ed-tv:setvolume')
AddEventHandler('ed-tv:setvolume', function(id, volume)
    if volume >= 0 and volume <= 10 then
        if data[id] then

            data[id]['Volume'] = volume

            TriggerClientEvent('ed-tv:updatevolume', -1, id, volume)

        end
    end
end)

RegisterServerEvent('ed-tv:destroy')
AddEventHandler('ed-tv:destroy', function(id)
    if data[id] then
        data[id] = nil
        TriggerClientEvent('ed-tv:delete', -1, id)
    end
end)