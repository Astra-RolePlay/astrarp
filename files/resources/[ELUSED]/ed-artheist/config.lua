...
Config['ArtHeist'] = {
    ['nextRob'] = 4000, -- seconds for next heist
...
Strings = {
    ...
    ['start_stealing'] = 'Hırsızlığa başlamak için ~INPUT_CONTEXT~ tuşuna basın',
    ...
    ['already_cuting'] = 'Zaten hırsızlık yapıyorsun.',
    ['already_heist'] = 'Zaten soyguna başladınız. Bitene kadar bekleyin.',
    ['start_heist'] = 'Soyguna başlamak için ~INPUT_CONTEXT~ tuşuna basın',
    ['sell_painting'] = 'Tabloyu satmak için ~INPUT_CONTEXT~ tuşuna basın',
    ['wait_nextrob'] = 'Bekleme süresi var, kalan süre -',
    ['minute'] = 'Dakika',
    ['police_alert'] = 'Sanat hırsızlığı alarmı! GPS\'nizi kontrol edin.',
    ['need_police'] = 'Şehirde yeterli polis yok.',
    ['wait_nextheist'] = 'Bekleme süresi var, kalan süre: '
