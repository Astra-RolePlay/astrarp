...
Config['TrainHeist'] = {
    ...
    ['reward'] = {
        ...
        sellPrice = 5000 -- buyer sell price
    },
...
Strings = {
    ...
    ['cutting'] = '~INPUT_CONTEXT~ Kasa kilidini kes',
    ['grab'] = '~INPUT_CONTEXT~ Altınları Topla',
    ['start_heist'] = '~INPUT_CONTEXT~ Tren Soygununu Başlat',
    ['goto_ambush'] = 'GPS\'ine eklenen konuma git ve korumaları öldür.',
    ['wait_nextrob'] = 'Diğer bir soyguna kadar beklemen gerekli',
    ['minute'] = 'dakika.',
    ['ambush_blip'] = 'Soygun Konumu',
    ['need_this'] = 'Şuna ihtiyacın var: ',
    ['deliver_to_buyer'] = 'Ganimetleri alıcıya teslim edin. gpsi kontrol et.',
    ['buyer_blip'] = 'Müşteri',
    ['need_police'] = 'Yeterli sayıda polis yok.',
    ['total_money'] = 'Kazandığın Toplam Para: ',
    ['police_alert'] = 'Tren soygunu alarmı! GPSinizi kontrol edin.',
}
