...
RegisterServerEvent('ed-peyote:pickedUpPeyote', function()
	local src = source
...
if GetCurrentResourceName() ~= "ed-peyote" then
    print("Error: Change the resource name to \"ed-peyote\" or it won't work!")
end