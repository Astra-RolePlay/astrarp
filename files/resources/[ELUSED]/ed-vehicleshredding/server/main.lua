...
RegisterServerEvent("ed-vehicleshredding:giveitem")
AddEventHandler("ed-vehicleshredding:giveitem", function(class)
    local src = source
...
RegisterNetEvent('ed-vehicleshredding:server:sellItems', function(itemName, itemAmount, itemPrice)
    local src = source
    ...
    TriggerClientEvent('ed-vehicleshredding:client:openMenu', src)
end)


QBCore.Functions.CreateCallback('ed-vehicleshredding:server:getInv', function(source, cb)
