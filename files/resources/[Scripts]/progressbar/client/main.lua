        ...
        if not isDoingAction then
            ...
            CreateThread(function ()
                ...
                while isDoingAction do
                    ...
                    if IsControlJustPressed(0, 202) and Action.canCancel then -- IsControlJustPressed(0, 202) BACKSPACE ESC
            ...
            TriggerEvent("QBCore:Notify", "Zaten bir şeyler yapıyorsun!", "error")
        end
    else
